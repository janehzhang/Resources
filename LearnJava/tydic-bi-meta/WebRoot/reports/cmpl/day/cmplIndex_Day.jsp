...
<%
	...
	String ind =(String)request.getParameter("ind")==null?"3":(String)request.getParameter("ind");	
	...
	if(dateTime==null || dateTime.equals("")){
		dateTime=dao.getMaxDate1("CS_CMPL_MONITOR_DAY_ZXD");
	...
	List<Map<String, Object>> indList = dao.getIndListDay(dateTime.replaceAll("-",""));
%>
<head>
					...
					<tr>
						<td valign="top" width="100%">
							   <table width='100%' style='border: 1px solid #87CEFF;'  border='0'  cellpadding='0px' cellspacing='0px'>
										<tr>
										     <td>
													<table id="queryCondition" width="550"  border="0" cellpadding="0" cellspacing="0">
													                <tr>
													               <td width='10%'>&nbsp;&nbsp;&nbsp;日期:
