...
<%
    ...
    String maxMon=dao.getMaxMonth("CS_CMPL_SUMMARY_MON_D");
    String dateTime =(String)request.getParameter("dateTime")==null?maxMon:(String)request.getParameter("dateTime");	
    String ind =(String)request.getParameter("ind")==null?"21":(String)request.getParameter("ind");
	...
	List<Map<String, Object>> indList = dao.getIndListMon_Zone();
	List<Map<String, Object>> monList = dao.getMonList("CS_CMPL_SUMMARY_MON_D");
...
<script type="text/javascript" src="cmplSumZone_Mon.js"></script>