...
<%
    ...
    String maxMon=dao.getMaxMonth("CS_CUST_CMPL_OFF_LINE");
    ...
    //String deptCode =(String)request.getParameter("deptCode")==null?"-1":(String)request.getParameter("deptCode");
	List<Map<String, Object>> monList = dao.getMonList("CS_CUST_CMPL_OFF_LINE");
%>
<head>
    <title>宽带及移动投诉用户离网责任部门报表</title>
    <%@include file="../../../portalCommon/public/head.jsp"%>
    <%@include file="../../../portalCommon/public/include.jsp" %>
    <script type="text/javascript"   src="<%=rootPath%>/dwr/interface/CmplIndexAction.js"></script>
    <script type="text/javascript"   src="<%=rootPath%>/dwr/interface/ZoneAction.js"></script>
    <script type="text/javascript"   src="<%=rootPath%>/dwr/interface/CmplDeptAction.js"></script>
    <script type="text/javascript"   src="<%=rootPath%>/js/My97DatePicker/WdatePicker.js"></script>
    <script type="text/javascript"   src="<%=rootPath%>/js/Charts/FusionCharts.js"></script>
    <script type="text/javascript"   src="<%=rootPath%>/js/common/zoneTree.js"></script>
    <script type="text/javascript"   src="<%=rootPath%>/js/common/deptTree.js"></script>
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value="宽带及移动投诉用户离网责任部门报表" />
	    ...
	    <table width='100%' >
          ...
          <select id="dateTime"    name="dateTime" style="width: 80px;">
		   ...
		   <%--<td width="200px">责任部门:&nbsp;
		   <input type="hidden""  id=deptCode   value="<%=deptCode%>"      name="deptCode" />
		   <input type="text"    id="dept"            name="dept" /></td>
...
<script type="text/javascript" src="cmplOffOnlineDept_Mon.js"></script>