...
{	
	...
	var ind=$("ind").value;
	var url="/reports/cmpl/mon/nativeCmplReason_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&ind="+ind+"&reasonId="+reasonId+"&channelType="+channelType+"&menuId="+menuId;
	return parent.openTreeTab("122034"+zoneCode, "投诉原因分析月报表"+"["+reason+"]", base+url, 'top');
}
