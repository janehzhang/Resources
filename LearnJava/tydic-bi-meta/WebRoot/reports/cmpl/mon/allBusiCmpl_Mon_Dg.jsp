	   ...
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
	    ...
	    <table width='100%' >
	     ...
	     <td width='5%'>&nbsp;&nbsp;&nbsp;&nbsp;<input type='button'  class="poster_btn" id="impBtn"    name="impBtn"    value="导  出" onclick="impExcel();"         style="width:60px;" /></td>
	      <%--<td width='10%'>&nbsp;&nbsp;&nbsp;&nbsp;
	      <input type="button" id="city" name="city" class="poster_btn" onclick="lookCity(this);" style="width:80px;"/></td>
													                --%></tr>
													</table>			        
										    </td>
										</tr>
...
<script type="text/javascript" src="allBusiCmpl_Mon_Dg.js"></script>