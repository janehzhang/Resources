...
<head>
    ...
    <script type="text/javascript"   src="<%=rootPath%>/dwr/interface/ReportConfigAction.js"></script>
											...
											<tr height='20px' style='background:url(/tydic-bi-meta/images/fpage_04.gif);'>
												...
												<td align='right'>指标项：
												  <select id="ind"    name="ind" style="width: 140px;" onchange="changeCol(this);">
											          <option value="3" >本地抱怨率</option>
											          <option value="1" >工信部申诉率</option>
											          <option value="2" >越级投诉率</option>
											          <option value="4" >本地投诉率</option>
											          <option value="5" >本地投诉直接解决率</option>
											          <option value="6" >投诉处理及时率</option>
											          <option value="7" >投诉处理一次完成率</option>
											          <option value="8" >增值业务投诉率</option>
											          <option value="9" >重复投诉量</option>
											          <option value="10" >重复投诉率</option>
											          <option value="11" >投诉用户回访满意率</option>
											          <option value="12" >全业务投诉率（集团）</option>
											          </select>
												</td>
											</tr>
											<tr>
