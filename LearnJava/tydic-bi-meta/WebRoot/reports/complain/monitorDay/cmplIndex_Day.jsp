...
<%
    ...
    String ind =(String)request.getParameter("ind")==null?"1":(String)request.getParameter("ind");	
	...
	List<Map<String, Object>> indList = dao.getIndListDay();
%>
<head>
    <title>投诉类指标日监测报表</title>
    ...
    <script type="text/javascript">
		function impExcel(){
	     	    var url = getBasePath()+"/reports/complain/monitorDay/impExcel/cmplIndexDay_impExcel.jsp";
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
	   <input type="hidden" name="title"    value="投诉类指标日监测报表">
	    <input type="hidden" name="colNames" value="大区,地市,指标项,当日值,本期累计,上月同期累计,环比,同比,本期平均">
	    <table width='100%' >
					<tr>
...
<script type="text/javascript" src="cmplIndex_Day.js"></script>