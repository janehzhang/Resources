		...
		var tableStr="<table width='100%' id='mytbl' border='0' cellpadding='0' cellspacing='0' class='tab_01'>"
			  +"<tr>"
			   +"<td bgcolor='#cde5fd' style='width:80px'><span class='title'>大区</span></td>"
			    ...
			    +"<td bgcolor='#cde5fd' style='width:120px'><span class='title'>渠道类型</span></td>"
			   ...
			   /* +"<td bgcolor='#cde5fd' style='width:60px'>回馈量</td>"
			    ...
			    +"<td bgcolor='#cde5fd' style='width:60px'><span class='title'>剔除查/咨询后总服务量</span></td>"
			 +"</tr>";
...
{	
	...
	var selectCol=$("selectCol").value;
	var channelTypeCode=$('channelTypeCode').value==""?'1':$("channelTypeCode").value;
	var url="/reports/channel/allBusiness/allBusiness_mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
	return parent.openTreeTab("118002"+zoneCode, "全渠道服务量分析月报"+"["+zoneName+"]", base+url, 'top');
}
//第一列合并
