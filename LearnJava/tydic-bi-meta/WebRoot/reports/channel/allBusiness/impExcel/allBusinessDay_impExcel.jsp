...
<%
    ...
    HSSFSheet sheet = workBook.createSheet("全渠道总体情况分析周报表");
   ...
   //queryData.put("weekNo",weekNo);
   List<Map<String, Object>> cellList=dao.getChannelGlobal_Day(queryData);
  if(cellList != null && cellList.size()>0 ){
	   for (Map<String, Object> key : cellList) {
	         ...
	         // data.add(key.get("BUSI_NUM").toString());
	         // data.add(key.get("YI_NUM").toString());
	         // data.add(key.get("ASIST_NUM").toString());
