...
//var titileInfo1=$("selectCol").options[$("selectCol").selectedIndex].text;
...
{	
	...
	//var selectCol=$("selectCol").value;
	//var channelTypeCode=$('channelTypeCode').value==""?'1':$("channelTypeCode").value;
	var url="/reports/channel/allBusinessAllZone/allBusiness_Day_New.jsp?zoneCode="+zoneCode+"&weekNo="+dateTime+"&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
	return parent.openTreeTab("119003"+zoneCode, "全渠道服务量分析周报"+"["+zoneName+"]", base+url, 'top');
	
}
//查询
var queryData=function(){
	/*changeCode=$("changeCode").value //by qx
	tZoneCode=$("zoneCode").value;
	tDefaultZoneCode=$("defaultZoneCode").value;
