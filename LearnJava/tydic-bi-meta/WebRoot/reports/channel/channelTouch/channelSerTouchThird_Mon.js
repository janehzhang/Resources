...
{	
	...
	var tempName="";
	if(thirdType=='0'){//办理
		 url="/reports/channel/newChannel/AreaServerThridTransaction_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+
		      "&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
		 tempId="179003";
		 tempName="区域渠道服务三级办理月报";
	}else{//查询
		 url="/reports/channel/newChannel/AreaServerThrid_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+
		     "&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
		 tempId="178003";
		 tempName="区域渠道服务三级查询月报";
	}
