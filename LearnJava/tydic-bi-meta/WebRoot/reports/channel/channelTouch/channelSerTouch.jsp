...
<% 
    ...
    String actType = request.getParameter("actType")==null?"2":(String)request.getParameter("actType");
	...
	List<Map<String, Object>> weekList=dao.getDateTimeList_ChannelServ("0","1","CS_CHANNEL_VIEW");
	request.setAttribute("dateTime",week);
	//月
	String month = request.getParameter("dateTime1");
	if(month==null || month.equals("")){
		month=dao.getMaxDate_ChannelServ(actType,"2","CS_CHANNEL_VIEW");
	}else{
		    clickTab="tab1";
	}
	...
	if(startTime==null || startTime.equals("")){
		dayTime=dao.getMaxDate_ChannelServ(actType,"0","CS_CHANNEL_VIEW");
...
<script type="text/javascript" src="channelSerTouch.js"></script>