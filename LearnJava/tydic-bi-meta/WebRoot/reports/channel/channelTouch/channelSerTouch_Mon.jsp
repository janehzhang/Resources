...
<% 
    ...
    List<Map<String,Object>>monList=dao.getSelectMon1(actType);
    if(dateTime==null || dateTime.equals("") ){
      dateTime=dao.getNewMonth1(actType);
    }
...
<script type="text/javascript" src="channelSerTouch_Mon.js"></script>