...
function tableHeader(headColumn){
	var tableHead="<tr>"
		    ...
		    +"<td bgcolor='#cde5fd' style='width:6%' ><span class='title'>充缴</span></td>" 
		    +"<td bgcolor='#cde5fd' style='width:6%' ><span class='title'>咨询</span></td>"
		    +"<td bgcolor='#cde5fd' style='width:6%' ><span class='title'>投诉</span></td>"
		    +"<td bgcolor='#cde5fd' style='width:6%' ><span class='title'>修障</span></td>"
...
{	
	...
	var url="/reports/channel/newChannel/AreaServer_Week.jsp?zoneCode="+zoneCode+"&weekNo="+dateTime+"&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
	return parent.openTreeTab("174001"+zoneCode+channelTypeCode, "区域渠道服务一级周报表"+"["+zoneName+"]", base+url, 'top');
