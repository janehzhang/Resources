...
<script type="text/javascript">
	function impExcel(form){
			    ...
			    var  queryCond="日期从："+startTime+"     至："+endTime+"     区域:"+zone+"   服务条件："+servId;
	     	    ...
	     	    var url = getBasePath()+"/portalCommon/module/procedure/impExcel/selfDefine/implExcel_rptChannelSerDetail.jsp";
...
<script type="text/javascript" src="rptChannelSerDetail.js"></script>