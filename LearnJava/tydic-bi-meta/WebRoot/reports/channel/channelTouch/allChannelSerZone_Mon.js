...
{	
	...
	var channelTypeCode=$('channelTypeCode').value==""?'1':$("channelTypeCode").value;
	var url="/reports/channel/channelTouch/allChannelSerZone_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&channelTypeCode="
	+channelTypeCode+"&selectCol="+selectCol+"&menuId="+menuId;
	return parent.openTreeTab("155014"+zoneCode+channelTypeCode, "全渠道服务区域月报"+"["+zoneName+"]", base+url, 'top');
}
//第一列合并
