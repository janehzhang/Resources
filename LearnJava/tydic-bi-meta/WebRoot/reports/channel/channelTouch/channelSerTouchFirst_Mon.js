...
{	
	...
	var url="/reports/channel/newChannel/AreaServer_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+
	"&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
	return parent.openTreeTab("174002"+zoneCode+channelTypeCode, "区域渠道服务一级月报表"+"["+zoneName+"]", base+url, 'top');
}
//第一列合并
