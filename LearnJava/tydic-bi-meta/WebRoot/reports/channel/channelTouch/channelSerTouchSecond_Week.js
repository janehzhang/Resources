...
{	
	...
	var url="/reports/channel/newChannel/AreaServerSecond_Week.jsp?zoneCode="+zoneCode+"&weekNo="+dateTime+"&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
	return parent.openTreeTab("175002"+zoneCode+channelTypeCode, "区域渠道服务二级周报表"+"["+zoneName+"]", base+url, 'top');
