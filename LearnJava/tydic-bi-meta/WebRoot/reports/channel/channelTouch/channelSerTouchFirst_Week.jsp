...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 ...
	 <form id="queryform" name="queryform">
        ...
        <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/allBusinessFirst_Day_New.xls" />
...
<script type="text/javascript" src="channelSerTouchFirst_Week.js"></script>