...
var excuteInitData=function(){
	...
	var cid1=$("cid1").value;
     ...
     AllChannelAction.getChannelSerClass_Pg(map, function (res) {
     	$('chartdiv1').innerHTML='';
     	$('chartdiv2').innerHTML='';
    	               dhx.closeProgress();
 				        if (res == null) {
...
{	
	...
	var url="/reports/channel/channelTouch/allChannelSerZone_Day.jsp?zoneCode="+zoneCode+"&startDate="+startDate+
	"&endDate="+endDate+"&channelTypeCode="+channelTypeCode+"&selectCol="+selectCol+"&menuId="+menuId;
