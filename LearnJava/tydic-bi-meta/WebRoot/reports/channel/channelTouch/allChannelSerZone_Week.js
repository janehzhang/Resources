...
{	
	...
	var channelTypeCode=$('channelTypeCode').value==""?'1':$("channelTypeCode").value;
	var url="/reports/channel/channelTouch/allChannelSerZone_Week.jsp?zoneCode="+zoneCode+"&weekNo="+dateTime+"&channelTypeCode="
	+channelTypeCode+"&selectCol="+selectCol+"&menuId="+menuId;
	return parent.openTreeTab("155013"+zoneCode+channelTypeCode, "全渠道服务区域周报"+"["+zoneName+"]", base+url, 'top');
