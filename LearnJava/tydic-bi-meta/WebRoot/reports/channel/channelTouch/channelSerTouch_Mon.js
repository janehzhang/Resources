...
{	
	...
	var url="/reports/channel/channelTouch/allChannelSerZone_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+
	"&channelTypeCode="+channelTypeCode+"&selectCol="+selectCol+"&menuId="+menuId;
