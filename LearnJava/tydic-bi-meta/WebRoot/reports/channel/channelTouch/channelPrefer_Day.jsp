...
<% 
	...
	String endDate = request.getParameter("endDate"); 
	 String preferType= (String)request.getParameter("preferType");
	if(startDate==null || startDate.equals("")){
		startDate=dao.getDayNew("CS_CHANNEL_VIEW");
...
<script type="text/javascript" src="channelPrefer_Day.js"></script>