...
<% 
    ...
    if(week==null || week.equals("")){
        week=dao.getMaxDate_ChannelServ(actType,"1","CS_CHANNEL_VIEW");
        week=week.replace("_","~");
    }
    ...
    List<Map<String, Object>> weekList=dao.getDateTimeList_ChannelServ(actType,"1","CS_CHANNEL_VIEW");
    String tempStr="";
    String excPath="";
											...
											<tr height='20px' style='background:url(/tydic-bi-meta/images/fpage_04.gif);'>
												...
												<%if ("0".equals(thirdType)||thirdType=="0"){ %>
												 <select id="selectCol"    name="selectCol" style="width: 180px;" onchange="changeCol(this);">       
										           ...
										           <option value="DEAL_NUM12" <%if("DEAL_NUM12".equals(selectCol)){ %> selected <%} %>> 办理_增值业务_变更</option>
										           <option value="DEAL_NUM13" <%if("DEAL_NUM13".equals(selectCol)){ %> selected <%} %>> 办理_增值业务_注销</option>
										           ...
										           <option value="DEAL_NUM22" <%if("DEAL_NUM22".equals(selectCol)){ %> selected <%} %>> 办理_套餐销售_换购机</option>
										           <option value="DEAL_NUM23" <%if("DEAL_NUM23".equals(selectCol)){ %> selected <%} %>> 办理_套餐销售_注销</option>
										           ...
										           <option value="DEAL_NUM31" <%if("DEAL_NUM3".equals(selectCol)){ %> selected <%} %>> 办理_套餐变更</option>
...
<script type="text/javascript" src="channelSerTouchThird_Week.js"></script>