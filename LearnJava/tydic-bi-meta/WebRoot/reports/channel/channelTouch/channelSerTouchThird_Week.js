...
{	
	...
	var tempName="";
	if(thirdType=='0'){//办理
		 url="/reports/channel/newChannel/AreaServerThridTransaction_Week.jsp?zoneCode="+zoneCode+"&weekNo="+dateTime+
		      "&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
		 tempId="179002";
		 tempName="区域渠道服务三级办理周报";
	}else{//查询
		 url="/reports/channel/newChannel/AreaServerThrid_Week.jsp?zoneCode="+zoneCode+"&weekNo="+dateTime+
		     "&channelTypeCode="+channelTypeCode+"&menuId="+menuId;
		 tempId="178002";
		 tempName="区域渠道服务三级查询周报";
	}
