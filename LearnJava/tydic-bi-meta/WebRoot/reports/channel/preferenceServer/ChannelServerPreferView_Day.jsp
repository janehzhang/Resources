...
<% 
	...
	if(startDate==null || startDate.equals("")){
		if(preferType.equals("1")){//客户等级
			tableName="CS_CHANNEL_VIEW_CUSTLEVEL";
			excelName="/upload/excelHeader/channelCustLevel_Day.xls";
		}
		if(preferType.equals("2")){
			tableName="CS_CHANNEL_VIEW_SERVGRP";
			excelName="/upload/excelHeader/channelCustGroup_Day.xls";
		}
		if(preferType.equals("3")){
			tableName="CS_CHANNEL_VIEW_BRAND";
			excelName="/upload/excelHeader/channelCustBrand_Day.xls";
		}
		if(preferType.equals("4")){
			tableName="CS_CHANNEL_VIEW_TOTALFEE";
			excelName="/upload/excelHeader/channelCustTotalfee_Day.xls";
		}
		if(preferType.equals("5")){
			tableName="CS_CHANNEL_VIEW_ONTIME";
			excelName="/upload/excelHeader/channelCustOntime_Day.xls";
		}
		if(preferType.equals("6")){
			tableName="CS_CHANNEL_VIEW_PAYMENT";
			excelName="/upload/excelHeader/channelCustPayment_Day.xls";
		}
		if(preferType.equals("7")){
			tableName="CS_CHANNEL_VIEW_TERMINAL";
			excelName="/upload/excelHeader/channelCustTerminal_Day.xls";
		}
		if(preferType.equals("8")){
			tableName="CS_CHANNEL_VIEW_MARKET";
			excelName="/upload/excelHeader/channelMarket_Day.xls";
		}											
		startDate=dao.getNewDay(tableName);
	...
	request.setAttribute("endDate", startDate);
	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="excelData"    name="excelData"   />
         ...
         <input type="hidden" id="filePath"    name="filePath" value=<%=excelName %> />
          <input type="hidden" id="row"    name="row" value="5" />
          <input type="hidden" id="explain"    name="explain"   />
          <input type="hidden" id="preferType"    name="preferType" value=<%=preferType %>  />
	    <table width='100%' >
					<tr>
...
<script type="text/javascript" src="ChannelServerPreferView_Day.js"></script>