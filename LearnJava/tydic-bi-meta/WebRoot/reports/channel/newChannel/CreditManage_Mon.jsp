	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="excelData"    name="excelData"   />
         ...
         <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/MKF_YDXYGL_MONTH.xls" />
          <input type="hidden" id="row"    name="row" value="7" />
...
<script type="text/javascript" src="CreditManage_Mon.js"></script>