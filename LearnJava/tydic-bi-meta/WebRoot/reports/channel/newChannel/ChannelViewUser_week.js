...
var excuteInitData=function(){
	indexExp();
		 ...
		 map.zoneCode=$('zoneCode').value==""?"0000":$("zoneCode").value;
 		 map.dateType="1";//周
 		 map.queryType=queryType;//表示 查询
 	     dhx.showProgress("正在执行......");
	     NewTwoChannelAction.queryChannelViewUser_pg(map, function (res) {
	     	   dhx.closeProgress();
	 			 if (res == null) {
...
function tableHeader(headColumn){
	var tableHead="<tr>"
		    ...
		    +"<td bgcolor='#cde5fd'  rowspan='2' ><span class='title'>总服务用户数</span></td>"
		 ...
		 +"</tr>"
		 +"<tr>"
		    +"<td bgcolor='#cde5fd' ><span class='title'>服务用户数</span></td>"
