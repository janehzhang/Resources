...
var excuteInitData=function(){
	     ...
	     NewTwoChannelAction.getHolidayCreditResultData(map, function (res) {
	     	   dhx.closeProgress();
	 			 if (res == null) {
...
function tableHeader(headColumn){
	var tableHead="<tr>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='3' ><span class='title'>起始时间</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%' colspan='5' ><span class='title' align='center' >目标用户情况</span></td>" 
	    //+"<td bgcolor='#cde5fd' style='width:3%' colspan='3' ><span class='title' align='center' >参与情况</span></td>" 
	    +"<td bgcolor='#cde5fd' style='width:20%' colspan='20'><span class='title' align='center'>成功办理的用户情况</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:7%' colspan='6'><span class='title' align='center'>成功办理用户的信控停复机情况</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:2%' colspan='2' ><span class='title' align='center' >成功办理用户欠费损失情况</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:7%' colspan='6' ><span class='title' align='center' >未办理目标用户情况</span></td>" 
	    +"<td bgcolor='#cde5fd' style='width:7%' colspan='6' ><span class='title' align='center' >非目标用户情况</span></td>" 
	 +"</tr>"
	 +"<tr>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>邀请用户数</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:4%' colspan='4'><span class='title'>星级客户分布</span></td>"
	    
	    //+"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>短信到达率</span></td>"
	    //+"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>短信回复率</span></td>"
	    //+"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>办理成功率</span></td>"
	    
	    +"<td bgcolor='#cde5fd' style='width:5%' colspan='5'><span class='title'>基础授信系数分布</span></td>"	    
	    +"<td bgcolor='#cde5fd' style='width:7%' colspan='7'><span class='title'>信用星级分布</span></td>"	    
	    +"<td bgcolor='#cde5fd' style='width:6%' colspan='6'><span class='title'>ARPU分布</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:2%' colspan='2'><span class='title'>节假日期间国际漫游</span></td>"
	    
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>节假日期间达到信停条件的用户数</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>假期结束后一日信停的用户数</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>3日复通率</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>5日复通率</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>7日复通率</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>当月复通率</span></td>"
	    //+"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>次月底复通率</span></td>"
	    
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>当月信停但当月未复机用户数</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>当月信停但当月未复机用户出账收入（万元）</span></td>"
	    
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>未办理的目标用户数</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>节假日期间信控停机用户数</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>3日复通率</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>5日复通率</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>7日复通率</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' rowspan='2'><span class='title'>当月复通率</span></td>"
	  ...
	  +"</tr>"
	  +"<tr>"
	    +"<td bgcolor='#cde5fd' style='width:1%' ><span class='title'>7星</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' ><span class='title'>6星</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' ><span class='title'>5星</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' ><span class='title'>4星及以下</span></td>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:1%' ><span class='title'>用户数</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:1%' ><span class='title'>用户占比</span></td>"
	  +"</tr>";
