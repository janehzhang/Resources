...
<% 
	String dateTime=(String)request.getParameter("dateTime");
	 ...
	 List<Map<String,Object>> monList=dao.getSelectMon2("MKF_YDXYGL_LSSX_MONITOR");
	 if(dateTime==null || dateTime.equals("") ){
      	dateTime=dao.getNewMonth("MKF_YDXYGL_LSSX_MONITOR");
    }
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
       ...
       <input type="hidden" value="getLSSXMonitorKBData"    name="classMethod"   />
	    ...
	    <table width='100%' >
		  <tr>
	       ...
	       <td>&nbsp;<input type='button'  class="poster_btn" id="impBtn"    name="impBtn"    value="文本导出"  onclick="exportExcel();"  style="width:80px;" /></td>
	     </tr>
													</table>			        
										    </td>
										</tr>
...
<script type="text/javascript" src="LSSX_MonitorKB.js"></script>