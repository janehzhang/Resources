...
if(headerLevel=="1"){
	tableHead="<tr>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:6%' ><span class='title'>区域</span></td>"
    ...
    tableHead="<tr>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:2%' rowspan='2' ><span class='title'>大区</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:2%' rowspan='2' ><span class='title'>区域</span></td>"
	...
	if(thirdType==0){//办理
	   tableHead="<tr>"
		    ...
		    +"<td bgcolor='#cde5fd' style='width:3%' rowspan='2' ><span class='title'>大区</span></td>"
		    +"<td bgcolor='#cde5fd' style='width:3%' rowspan='2' ><span class='title'>区域</span></td>"
		 ...
		 tableHead="<tr>"
		    ...
		    tableHead="<tr>"
			   // +"<td bgcolor='#cde5fd'  rowspan='3'><span class='title'>大区</span></td>"
			    +"<td bgcolor='#cde5fd' style='width:5%'  rowspan='2' ><span class='title'>大区</span></td>"
			    +"<td bgcolor='#cde5fd' style='width:5%' rowspan='2' ><span class='title'>区域</span></td>"
...
var queryData=function(){
     ...
     NewTwoChannelAction.getAreaServerSum_Pg(map, function (res) {
    	 dhx.closeProgress();
 		 if (res == null) {
