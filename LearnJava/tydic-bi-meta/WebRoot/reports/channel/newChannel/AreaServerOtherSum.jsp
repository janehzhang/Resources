...
<% 
    ...
    if(headerLevel.equals("1")){
    	filePath="/upload/excelHeader/AreaChannelServerFirst.xls";
    	row=5;
    }else if(headerLevel.equals("2")){
    	filePath="/upload/excelHeader/AreaChannelServerSecond.xls";
    	row=5;
    }else{
    	if(thirdType.equals("0")){//办理
    		filePath="/upload/excelHeader/AreaChannelServerThird_BanLi.xls";
        }else if(thirdType.equals("1")){//查询
        	filePath="/upload/excelHeader/AreaChannelServerThird_ChaXun.xls";
        }else if(thirdType.equals("2")){//咨询
        	filePath="/upload/excelHeader/AreaChannelServerThird_ZiXun.xls";
        }else{//充值交费
        	filePath="/upload/excelHeader/AreaChannelServerThird_CZJF.xls";
        }
    	row=5;
    }
    //周
...
<script type="text/javascript" src="AreaServerOtherSum.js"></script>