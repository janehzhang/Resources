...
<% 
     ...
     if(week==null || week.equals("")){
         week=dao.getMaxWeek2("CS_CHANNEL_VIEW");
         week=week.replace("_","~");
     }
	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="excelData"    name="excelData"   />
         ...
         <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/Area_Channel_Thrid_Day.xls" />
...
<script type="text/javascript" src="AreaServerThridTransaction_Week.js"></script>