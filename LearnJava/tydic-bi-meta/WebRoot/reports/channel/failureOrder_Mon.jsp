...
<% 
	 ...
	 if(month==null || month.equals("")){
		 month=dao.getMaxMonthIndex("CS_CHANNEL_FUALT_DISTRI",indexId);
	 }
	 List<Map<String, Object>> monList=dao.getListMonIndex("CS_CHANNEL_FUALT_DISTRI",indexId);
%>
<head>
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
        ...
        <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/failureOrderMon.xls" />
...
<script type="text/javascript" src="failureOrder_Mon.js"></script>