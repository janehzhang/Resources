...
var excuteInitData=function(){
	     ...
	     NewTwoChannelAction.queryKeyAll_pg1(map, function (res) {
	     	   dhx.closeProgress();
	 			 if (res == null) {
...
function tableHeader(headColumn){
 if(reportType=='1001'){
  var tableHead="<tr>"
		+"<td bgcolor='#cde5fd' rowspan='3' style='width:6%'><span class='title'>地区</span></td>"
	    +"<td bgcolor='#cde5fd' rowspan='3' style='width:6%' ><span class='title'>分公司</span></td>"
	    +"<td bgcolor='#cde5fd' colspan='7'><span class='title' align='center' >触点满意率</span></td>" 
	    +"<td bgcolor='#cde5fd' colspan='4'><span class='title' align='center'>网络质量</span></td>"
	 ...
	 if(reportType=='1002'){
 		 var tableHead="<tr>"
		    ...
		    +"<td bgcolor='#cde5fd' colspan='5'><span class='title' align='center' >工信部申诉率（百万）</span></td>" 
		    ...
		    +"<td bgcolor='#cde5fd' ><span class='title' align='center'>累计月均值</span></td>"
		    +"<td bgcolor='#cde5fd' ><span class='title' align='center'>同比升降幅度</span></td>"
		    /*+"<td bgcolor='#cde5fd'  ><span class='title' align='center'>当月投诉一次性解决量</span></td>"*/
		    ...
		    /*+"<td bgcolor='#cde5fd'  ><span class='title' align='center'>同比升降幅度</span></td>"
		    +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>当月投诉处理回访满意量</span></td>"*/
		    +"<td bgcolor='#cde5fd' ><span class='title' align='center'>当月投诉处理回访满意率</span></td>"
		     ...
		     /*+"<td bgcolor='#cde5fd'  ><span class='title' align='center'>同比升降幅度</span></td>"
		     +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>当月重复投诉处理量</span></td>"*/
		    +"<td bgcolor='#cde5fd' ><span class='title' align='center'>当月重复投诉处理率</span></td>"
		    +"<td bgcolor='#cde5fd' ><span class='title' align='center'>环比升降幅度</span></td>"
		    /* +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>截至本月重复投诉处理率</span></td>"
		    +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>同比升降幅度</span></td>"
		    +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>当月投诉处理及时量</span></td>"*/
		     +"<td bgcolor='#cde5fd' ><span class='title' align='center'>当月投诉处理及时率</span></td>"	     
		    +"<td bgcolor='#cde5fd' ><span class='title' align='center'>环比升降幅度</span></td>"
		   /* +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>截至本月投诉处理及时率</span></td>"
		    +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>同比升降幅度</span></td>"
		    +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>当月升级督办量</span></td>"*/
		    ...
		    /* +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>截至本月升级督办率</span></td>"
		     +"<td bgcolor='#cde5fd'  ><span class='title' align='center'>同比升降幅度</span></td>"*/
		 +"</tr>";
	 } 
	 if(reportType=='3'){
 		 var tableHead="<tr>"
			+"<td bgcolor='#cde5fd' rowspan='4' style='width:6%'><span class='title'>地区</span></td>"
		    +"<td bgcolor='#cde5fd' rowspan='4' style='width:6%' ><span class='title'>分公司</span></td>"
		    +"<td bgcolor='#cde5fd' rowspan='4'><span class='title' align='center' >移动用户数到达值（万户）</span></td>" 
	 ...
	 if(reportType=='4'){
 		 var tableHead="<tr>"
			+"<td bgcolor='#cde5fd' rowspan='4' style='width:6%'><span class='title'>地区</span></td>"
		    +"<td bgcolor='#cde5fd' rowspan='4' style='width:6%' ><span class='title'>分公司</span></td>"
		    +"<td bgcolor='#cde5fd' rowspan='4'><span class='title' align='center' >宽带用户数到达值（万户）</span></td>" 
