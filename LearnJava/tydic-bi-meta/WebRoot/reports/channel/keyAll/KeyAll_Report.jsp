...
String reportName="";
	 List<Map<String,Object>>monList=dao.getKeyMonth("CS_KF_INDEX_EXPRESSION",reportType);
	 if(dateTime==null || dateTime.equals("") ){
      	dateTime=dao.getKeyMonth2("CS_KF_INDEX_EXPRESSION",reportType);
    }
	if(reportType.equals("1001")){
	   reportName="/upload/excelHeader/KeyReport_01.xls";
	}
	if(reportType.equals("1002")){
	   reportName="/upload/excelHeader/KeyReport_02.xls";
	}	
	if(reportType.equals("1003")){
	   reportName="/upload/excelHeader/KeyReport_03.xls";
	}
	if(reportType.equals("1004")){
	   reportName="/upload/excelHeader/KeyReport_04.xls";
	}
	if(reportType.equals("1005")){
	   reportName="/upload/excelHeader/KeyReport_05.xls";
	}	
	if(reportType.equals("1006")){
	   reportName="/upload/excelHeader/KeyReport_06.xls";
	}					
%>
<head>
...
<script type="text/javascript" src="keyAll_Mon.js"></script>