...
var typeList=$("channelTypeCode").value;
...
{	
	...
	var channelTypeCode=$('channelTypeCode').value==""?'1':$("channelTypeCode").value;
	var url="/reports/channel/allBusinessAllZone/allBusiness_Day_New2.jsp?zoneCode="+zoneCode+"&startDate="+startDate+"&endDate="+endDate+"&channelTypeCode="
	+channelTypeCode+"&selectType="+selectType+"&selectCol="+selectCol+"&menuId="+menuId;
	return parent.openTreeTab("149002"+zoneCode, "全渠道服务区域日报"+"["+zoneName+"]", base+url, 'top');
