...
<%@ page import="java.util.Date,tydic.reports.channel.allBusiness.AllBusinessDAO_New" %>
...
<% 
    ...
    String selectType = request.getParameter("selectType")==null?"14001":(String)request.getParameter("selectType");
    String dateTime=(String)request.getParameter("dateTime");	
    AllBusinessDAO_New allBusinessDao=new AllBusinessDAO_New();
    List<Map<String,Object>> typeList=allBusinessDao.getSelectType_Code(channelTypeCode);
    List<Map<String,Object>> monList=allBusinessDao.getSelectMon();
    if(dateTime==null || dateTime.equals("") ){
      dateTime=allBusinessDao.getNewMonth();
    }
...
<script type="text/javascript" src="allBusiness_Mon_New.js"></script>