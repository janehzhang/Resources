...
<% 
   NewChannelDao dao=new NewChannelDao();
     ...
     if(monthId==null || monthId.equals("")){
    	 monthId=dao.getMaxMonth("CS_CHANNEL_PREFER_IDX_10000","6");
     }
	 String areaCode="0000";
	 String zoneCode = request.getParameter("zoneCode")==null?areaCode:(String)request.getParameter("zoneCode");
	 List<Map<String, Object>> monthList=dao.getMonList("CS_CHANNEL_PREFER_IDX_10000","6");
	 String rptId = request.getParameter("rptId")==null?"1":(String)request.getParameter("rptId");
	 String filePath="";
	 if("1".equals(rptId)){
		 filePath="/upload/excelHeader/channelPreferIndex10000.xls";
	 }else if("2".equals(rptId)){
		 filePath="/upload/excelHeader/channelPreferIndexZyt.xls";
	 }else if("3".equals(rptId)){
		 filePath="/upload/excelHeader/channelPreferIndexDt.xls";
	 }
%>
<head>
...
<script type="text/javascript" src="channelPreferIndex.js"></script>