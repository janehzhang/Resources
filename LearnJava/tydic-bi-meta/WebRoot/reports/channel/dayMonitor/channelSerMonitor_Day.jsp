...
<% 
	...
	if(dateTime==null || dateTime.equals("")){
		dateTime=dao.getNewDay("CS_CHANNEL_MONITOR_DAY");
	 ...
	 List<Map<String, Object>> indList=dao.getSelectIndType("CS_CHANNEL_MONITOR_DAY");
	 String parameters=dao.getParameters("40001");
									...
									<td width='50%'>
										<table  width='100%' height='200px' style='border: 1px solid #87CEFF;' border='0' cellpadding='0' cellspacing='0'>
											<tr height='20px' style='background:url(/tydic-bi-meta/images/fpage_04.gif);'>
												...
												<td align='right'>指标项：
												  <select id="indId"    name="indId" style="width: 210px;" onchange="changeCol(this);"> 
...
<script type="text/javascript" src="channelSerMonitor_Day.js"></script>