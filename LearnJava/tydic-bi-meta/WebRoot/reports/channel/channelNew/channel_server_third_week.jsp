...
<% 
   NewChannelDao dao=new NewChannelDao();
    ...
    if(thirdType.equals("0")){//办理
        excelName="/upload/excelHeader/channelNewThrid_BanLiDay.xls";
    }else if(thirdType.equals("1")){//查询
        excelName="/upload/excelHeader/channelNewThrid_QueryDay.xls";
    }else{
       excelName="/upload/excelHeader/channelNewThrid_ZixunDay.xls";
     }
%>
<head>
...
<script type="text/javascript" src="channel_server_third_week.js"></script>