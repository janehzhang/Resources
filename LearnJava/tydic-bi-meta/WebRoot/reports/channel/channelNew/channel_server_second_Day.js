...
var excuteInitData=function(){
	...
	// map.field=$("selectCol").value;
     ...
     NewTwoChannelAction.getChannelSerNewSecond_Pg(map, function (res) {
    	 dhx.closeProgress();
 		 if (res == null) {
...
function tableHeader(headColumn){
	var tableHead="<tr>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:20%' colspan='8'><span class='title' align='center'>办理</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:20%' colspan='7'><span class='title' align='center'>咨询</span></td>"
	 ...
	 +"<tr>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>订单查询</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>查询总量</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>加装</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>变更</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>续约</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>退订</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>购买</span></td>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>优惠活动类咨询</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>服务信息类咨询</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>资源类咨询</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>业务信息</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>产品演示</span></td>"
	    +"<td bgcolor='#cde5fd' style='width:5%'><span class='title'>使用指南</span></td>"
