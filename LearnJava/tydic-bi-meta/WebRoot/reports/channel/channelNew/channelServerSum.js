...
if(headerLevel=="1"){
    ...
    tableHead="<tr>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:6%' colspan='2' ><span class='title' align='center' >充值交费</span></td>" 
	    ...
	    +"<td bgcolor='#cde5fd' style='width:2%' rowspan='2' ><span class='title'>其他（非集团）</span></td>"
	 ...
	 +"<tr>"
	    ...
	    +"<td bgcolor='#cde5fd' style='width:3%'><span class='title'>退订（拆机）</span></td>"
	...
	if(thirdType==0){//办理
	   tableHead="<tr>"
		    ...
		    +"<td bgcolor='#cde5fd' style='width:21%' colspan='7'><span class='title'>退订（拆机）</span></td>"
		 ...
		 tableHead="<tr>"
		    ...
		    tableHead="<tr>"
			    ...
			    +"<td bgcolor='#cde5fd' style='width:6%' colspan='2'><span class='title'>产品演示</span></td>"
			     ...
			     +"<td bgcolor='#cde5fd' style='width:9%' colspan='3'><span class='title'>其他知识（非集团）</span></td>"
			     +"<td bgcolor='#cde5fd' style='width:3%' rowspan='2'><span class='title'>其他（非集团）</span></td>"
			 ...
			 +"<tr>"
			    ...
			    +"<td bgcolor='#cde5fd' style='width:3%'><span class='title'>密码服务（非集团）</span></td>"
			    +"<td bgcolor='#cde5fd' style='width:3%'><span class='title'>其他</span></td>"
			    ...
			    +"<td bgcolor='#cde5fd' style='width:3%'><span class='title'>政企产品</span></td>"
			    +"<td bgcolor='#cde5fd' style='width:3%'><span class='title'>行业应用</span></td>"
			    +"<td bgcolor='#cde5fd' style='width:3%'><span class='title'>增值业务（非集团）</span></td>"
			    +"<td bgcolor='#cde5fd' style='width:3%'><span class='title'>其他</span></td>"
...
var queryData=function(){
	 ...
	 $("cid3").value=Math.random();
	 var cid3=$("cid3").value;
	 
	 $("cid4").value=Math.random();
	 var cid4=$("cid4").value;
	 
	 $("cid5").value=Math.random();
	 var cid5=$("cid5").value;
	 
	 $("cid6").value=Math.random();
	 var cid6=$("cid6").value;
     ...
     NewTwoChannelAction.getChannelSer_Pg(map, function (res) {
    	 $('chartdiv7').innerHTML='';
     	 $('chartdiv8').innerHTML='';
     	 $('chartdiv9').innerHTML='';
 		...
 		chart1=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId1_"+cid1, "100%", "200", "0", "0");
   	    chart2=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId2_"+cid2, "100%", "200", "0", "0");
   	    chart3=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId3_"+cid3, "100%", "200", "0", "0");
	    chart4=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId4_"+cid4, "100%", "200", "0", "0");
	    chart5=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId5_"+cid5, "100%", "200", "0", "0");
	    chart6=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId6_"+cid6, "100%", "200", "0", "0");
        chart1.setDataXML(res.lineChartMap1);
        chart2.setDataXML(res.lineChartMap12);
        chart3.setDataXML(res.lineChartMap2);
        chart4.setDataXML(res.lineChartMap22);
        chart5.setDataXML(res.lineChartMap3);
        chart6.setDataXML(res.lineChartMap4);
        chart1.render("chartdiv7");
        chart2.render("chartdiv8"); 
        chart3.render("chartdiv9");
        chart4.render("chartdiv10");
        chart5.render("chartdiv11");
        chart6.render("chartdiv12");
...
var queryData1=function(){
    ...
    NewTwoChannelAction.getChannelSer_Pg(map, function (res) {
    	...
    	$('chartdiv15').innerHTML='';
    	$('chartdiv16').innerHTML='';
    	$('chartdiv17').innerHTML='';
    	$('chartdiv18').innerHTML='';
   	 dhx.closeProgress();
		 if (res == null) {
			 dhx.alert("读取数据发生错误,请稍后重试，或者联系系统管理员!");
			 return;
		 ...
		 chart1=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId1_"+cid1, "100%", "200", "0", "0");
	   	 ...
	   	 chart3=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId3_"+cid3, "100%", "200", "0", "0");
		 chart4=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId4_"+cid4, "100%", "200", "0", "0");
		 chart5=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId4_"+cid5, "100%", "200", "0", "0");
		 chart6=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId4_"+cid6, "100%", "200", "0", "0");
	     chart1.setDataXML(res.lineChartMap1);
	     chart2.setDataXML(res.lineChartMap12);
	     chart3.setDataXML(res.lineChartMap2);
	     chart4.setDataXML(res.lineChartMap22);
	     ...
	     chart3.render("chartdiv15");
	     chart4.render("chartdiv16");
	     chart5.render("chartdiv17");
	     chart6.render("chartdiv18");
		 $("div_src").style.display = "none";
		 $("div_src").style.zindex = "-1";
		 buildTable1(res);
   });	
...
function buildChart(map){
	dhx.showProgress("正在执行......");
	NewTwoChannelAction.changeFirstChart(map, {callback:function (res) {
		dhx.closeProgress();
    	         if(res != null){
                        buildBLChart(res);
		         }
...
function  buildBLChart(map){
	...
	chart5=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId5_"+cid5, "100%", "200", "0", "0");
	chart6=new FusionCharts(base+"/js/Charts/MSLine.swf", "ChartId6_"+cid6, "100%", "200", "0", "0");
	chart1.setDataXML(map.lineChartMap1);
	chart2.setDataXML(map.lineChartMap12);
	chart3.setDataXML(map.lineChartMap2);
	chart4.setDataXML(map.lineChartMap22);
	chart5.setDataXML(map.lineChartMap3);
	chart6.setDataXML(map.lineChartMap4);
	chart1.render("chartdiv7");
	chart2.render("chartdiv8"); 
	chart3.render("chartdiv9");
	chart4.render("chartdiv10");
...
function exportImage(){
    ...
    var charts3 = getChartFromId("ChartId3_"+cid3);
    var charts4 = getChartFromId("ChartId4_"+cid4);
    var charts5 = getChartFromId("ChartId5_"+cid5);
    var charts6 = getChartFromId("ChartId6_"+cid6);
    charts1.exportChart();
    charts2.exportChart(); 
    charts3.exportChart(); 
    charts4.exportChart(); 
