...
<% 
    ...
    String selectCol =(String)request.getParameter("selectCol")==null?"SERVICE_NUM":(String)request.getParameter("selectCol");
    String filePath="";
    int row=0; 
	...
	<tr>
	 <td valign="top" width="100%">
		...
		<tr>
		   ...
		   <input type="text"     id="channelType2"  size="20"    value=<%=channelType%>  name="channelType2" /></td>
									...
									<td width='50%'>
										<table  width='100%' height='200px' style='border: 1px solid #87CEFF;' border='0' cellpadding='0' cellspacing='0'>
											<tr height='20px' style='background:url(/tydic-bi-meta/images/fpage_04.gif);'>
												...
												<td align='right'>指标:
												 <select id="selectCol2"    name="selectCol2" style="width: 120px;" onchange="changeCol2(this);">
												   <option value="QUERY_NUM" <%if("QUERY_NUM".equals(selectCol)){ %> selected <%} %>>查询</option>
												   <option value="PAY_NUM" <%if("PAY_NUM".equals(selectCol)){ %> selected <%} %>>充值缴费</option>
										           ...
										           <option value="OTHER_NUM" <%if("OTHER_NUM".equals(selectCol)){ %> selected <%} %>>其他</option>  
		...
		<tr>
         <td style="width: 200px;">周期:
          ...
          <% 
		   ...
		   <input type="text"     id="channelType"  size="20"    value=<%=channelType%>  name="channelType" /></td>
									...
									<td width='50%'>
										<table  width='100%' height='200px' style='border: 1px solid #87CEFF;' border='0' cellpadding='0' cellspacing='0'>
											<tr height='20px' style='background:url(/tydic-bi-meta/images/fpage_04.gif);'>
												...
												<td align='right'>指标:
												 <select id="selectCol"    name="selectCol" style="width: 120px;" onchange="changeCol(this);">
												   <option value="QUERY_NUM" <%if("QUERY_NUM".equals(selectCol)){ %> selected <%} %>>查询</option>
												   <option value="PAY_NUM" <%if("PAY_NUM".equals(selectCol)){ %> selected <%} %>>充值缴费</option>
												   <option value="DEAL_NUM" <%if("DEAL_NUM".equals(selectCol)){ %> selected <%} %>>办理</option>
												   <option value="CONSULT_NUM" <%if("CONSULT_NUM".equals(selectCol)){ %> selected <%} %>>咨询</option>
		...
		<tr>
         <td style="width: 150px;">月份:
          ...
          <% 
		   ...
		   <input type="text"     id="channelType1"  size="20"    value=<%=channelType%>  name="channelType1" /></td>
									...
									<td width='50%'>
										<table  width='100%' height='200px' style='border: 1px solid #87CEFF;' border='0' cellpadding='0' cellspacing='0'>
											<tr height='20px' style='background:url(/tydic-bi-meta/images/fpage_04.gif);'>
												...
												<td align='right'>指标:
												 <select id="selectCol1"    name="selectCol1" style="width: 120px;" onchange="changeCol1(this);">
												   <option value="QUERY_NUM" <%if("QUERY_NUM".equals(selectCol)){ %> selected <%} %>>查询</option>
												   <option value="PAY_NUM" <%if("PAY_NUM".equals(selectCol)){ %> selected <%} %>>充值缴费</option>
												   <option value="DEAL_NUM" <%if("DEAL_NUM".equals(selectCol)){ %> selected <%} %>>办理</option>
												   <option value="CONSULT_NUM" <%if("CONSULT_NUM".equals(selectCol)){ %> selected <%} %>>咨询</option>
...
<script type="text/javascript" src="channelServerSumChart.js"></script>