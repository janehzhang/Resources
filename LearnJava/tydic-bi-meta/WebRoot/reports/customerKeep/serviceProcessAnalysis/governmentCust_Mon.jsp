...
<% 
	...
	// String selectCol = request.getParameter("selectCol")==null?"NUM13":(String)request.getParameter("selectCol");
	 ...
	 String parameters=dao.getParameters("30016");
%>
<head>
	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="parameters"    name="parameters" value=<%=parameters%> />
         <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/governmentCust_Mon.xls" />
...
<script type="text/javascript" src="governmentCust_Mon.js"></script>