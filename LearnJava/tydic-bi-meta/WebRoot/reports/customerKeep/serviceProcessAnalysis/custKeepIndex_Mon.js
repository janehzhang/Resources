...
var excuteInitData=function(){
     ...
     map.selectCol=$("selectCol").value;
     map.field="CURRENT_VALUE";
     map.rptIndex="custKeepIndexMon";
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/custKeepIndex_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode+"&selectCol="+$('selectCol').value+"&prodTypeCode="+$('prodTypeCode').value+"&menuId="+menuId;
	return parent.openTreeTab("122015"+zoneCode,"客户保有类指标月监测报表"+"["+zoneName+"]",base+url,'top');	
}
/**
 * 
 * @param myObject
