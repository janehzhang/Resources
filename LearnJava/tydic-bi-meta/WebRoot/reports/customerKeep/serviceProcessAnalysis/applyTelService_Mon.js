...
var  tableHead="<tr>"
	...
	+"<td nowrap bgcolor='#cde5fd'  style='width:1200px' colspan='24'><span class='title'>话务情况</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  style='width:200px' colspan='3'><span class='title'>故障下单情况</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  style='width:250px' colspan='3'><span class='title'>工作流下单情况（投诉单）</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  style='width:250px' colspan='3'><span class='title'>工作流下单情况（需求单）</span></td>"
	+"</tr><tr>"
	+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>IVR呼叫量</span></td>"
	+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>人工呼叫量</span></td>"
	+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>人工接通量</span></td>"
	+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>咨询</span></td>"
	+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>查询</span></td>"
	+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>办理</span></td>"
	+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>报障</span></td>"
	+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>投诉</span></td>"
	
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>行业应用政企用户</span></td>"
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>行业应用非政企用户</span></td>"
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>小计</span></td>"
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>行业应用政企用户</span></td>"
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>行业应用非政企用户</span></td>"
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>小计</span></td>"
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>行业应用政企用户</span></td>"
	...
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>小计</span></td>"
	+"</tr><tr>"
	+"<td bgcolor='#cde5fd' ><span class='title'>行业应用政企用户</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>行业应用非政企用户</span></td>"
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/applyTelService_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode;
	return parent.openTreeTab("128002"+zoneCode,"行业应用用户来电服务月报"+"["+zoneName+"]",base+url,'top');	
}
//指标解释
function indexExp(){
	 $('index_exp').innerHTML='';
