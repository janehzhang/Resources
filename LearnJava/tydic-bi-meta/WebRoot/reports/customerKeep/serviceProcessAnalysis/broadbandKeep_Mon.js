...
var  tableHead="<tr>"
	...
	+"<td nowrap bgcolor='#cde5fd' style='width:350px' colspan='7'><span class='title'>考核指标</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:400px' colspan='8'><span class='title'>存量用户质量观察指标</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:300px' colspan='6'><span class='title'>离网观察指标</span></td>"
	+"</tr><tr>"
	+"<td bgcolor='#cde5fd' colspan='7'><span class='title'>接入终端宽带月均离网率</span></td>"
	+"<td bgcolor='#cde5fd' colspan='2' rowspan='2'><span class='title'>宽带预存融合率</span></td>"
	+"<td bgcolor='#cde5fd' colspan='2' rowspan='2'><span class='title'>宽带预存率</span></td>"
	+"<td bgcolor='#cde5fd' colspan='2' rowspan='2'><span class='title'>宽带到期续约率（M）</span></td>"
	+"<td bgcolor='#cde5fd' colspan='2' rowspan='2'><span class='title'>光纤宽带12M及以上占比</span></td>"
	//+"<td bgcolor='#cde5fd' colspan='2' rowspan='2'><span class='title'>钻金银宽带用户互视融合渗透率</span></td>"
	+"<td bgcolor='#cde5fd' colspan='6'><span class='title'>接入终端宽带当月离网率</span></td>"
	+"</tr><tr>"
	+"<td nowrap bgcolor='#cde5fd'  colspan='3'><span class='title'>全体用户</span></td>"
	...
	+"<td nowrap bgcolor='#cde5fd'  colspan='2'><span class='title'>全体用户</span></td>"
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/broadbandKeep_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode;
	return parent.openTreeTab("126002"+zoneCode,"宽带维系月报表"+"["+zoneName+"]",base+url,'top');	
}
/**
 * 
 * @param myObject
