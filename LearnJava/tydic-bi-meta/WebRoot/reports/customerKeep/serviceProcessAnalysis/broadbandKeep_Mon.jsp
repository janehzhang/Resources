...
<% 
	...
	if(month==null || month.equals("")){
		 month=dao.getNewMonth("CS_CUST_BROADBAND_MON");
	}
	 String areaCode="0000";
	 String zoneCode = request.getParameter("zoneCode")==null?areaCode:(String)request.getParameter("zoneCode");
	 List<Map<String, Object>> monList=dao.getSelectMon("CS_CUST_BROADBAND_MON");
	 String parameters=dao.getParameters("30013");
%>
<head>
    <title>宽带维系月报表</title>
	...
	function impExcel(form){
	    ...
	    var queryCond="月 份："+dateTime+" 区域："+zone;
 	    ...
 	    var url = getBasePath()+"/portalCommon/module/procedure/impExcel/selfDefine/implExcel_broadbandKeep.jsp";
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value="宽带维系月报表" />
...
<script type="text/javascript" src="broadbandKeep_Mon.js"></script>