...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/VIPEnjoyCust_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode;
	return parent.openTreeTab("126010"+zoneCode,"VIP尊享客户端到达客户数月报表"+"["+zoneName+"]",base+url,'top');	
}
/**
 * 
 * @param myObject
