...
var  tableHead="<tr>"
	...
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>小计</span></td>"
	+"</tr><tr>"
	+"<td bgcolor='#cde5fd'><span class='title'>VPN政企用户</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>VPN非政企用户</span></td>"
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/VPNTelService_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode;
	return parent.openTreeTab("128001"+zoneCode,"VPN用户来电服务月报"+"["+zoneName+"]",base+url,'top');	
}
//指标解释
function indexExp(){
	 $('index_exp').innerHTML='';
