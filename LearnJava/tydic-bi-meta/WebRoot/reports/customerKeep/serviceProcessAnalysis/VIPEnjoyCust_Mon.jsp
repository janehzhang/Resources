...
<% 
	...
	if(month==null || month.equals("")){
		 month=dao.getNewMonth("CS_VIP_CLIENT_CUST_MON");
	}
	 String areaCode="0000";
	 String zoneCode = request.getParameter("zoneCode")==null?areaCode:(String)request.getParameter("zoneCode");
	 List<Map<String, Object>> monList=dao.getSelectMon("CS_VIP_CLIENT_CUST_MON");
	 String parameters=dao.getParameters("30015");
%>
<head>
    <title>VIP尊享客户端到达客户数月报表</title>
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value="VIP尊享客户端到达客户数月报表" />
...
<script type="text/javascript" src="VIPEnjoyCust_Mon.js"></script>