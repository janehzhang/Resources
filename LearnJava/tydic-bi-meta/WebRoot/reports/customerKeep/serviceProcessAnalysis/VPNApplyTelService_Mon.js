...
var  tableHead="<tr>"
	...
	+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>小计</span></td>"
	+"</tr><tr>"
	+"<td bgcolor='#cde5fd'><span class='title'>VPN&行业应用政企用户</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>VPN&行业应用非政企用户</span></td>"
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/VPNApplyTelService_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode;
	return parent.openTreeTab("128003"+zoneCode,"VPN及行业应用双重身份来电服务月报"+"["+zoneName+"]",base+url,'top');	
}
//指标解释
function indexExp(){
	 $('index_exp').innerHTML='';
