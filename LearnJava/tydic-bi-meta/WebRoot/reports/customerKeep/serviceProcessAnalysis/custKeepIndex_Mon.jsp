...
<% 
	...
	if(month==null || month.equals("")){
		 month=dao.getNewMonth("CS_CUST_MON");
	}
	 ...
	 String selectCol = request.getParameter("selectCol")==null?"4":(String)request.getParameter("selectCol");
	 String prodTypeCode = request.getParameter("prodTypeCode")==null?"":(String)request.getParameter("prodTypeCode");
	 List<Map<String, Object>> monList=dao.getSelectMon("CS_CUST_MON");
	 List<Map<String, Object>> indList=dao.getSelectInd("CS_CUST_MON");
	 List<Map<String, Object>> prodTypeList=dao.getSelectProdType("CS_CUST_MON");
	 String parameters=dao.getParameters("30003");
%>
<head>
       ...
       <td width='15%'>&nbsp;&nbsp;&nbsp;区域:
		...
		<td width='15%'>&nbsp;&nbsp;&nbsp;业务类型:
	     ...
	     <td width='10%'>&nbsp;<input type='button'  class="poster_btn" id="impBtn"    name="impBtn"    value="导  出" onclick="impExcel();"         style="width:60px;" /></td>
          ...
          if(selectCol.equals(key.get("IND_ID"))){
           %>
...
<script type="text/javascript" src="custKeepIndex_Mon.js"></script>