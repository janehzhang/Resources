...
<% 
	...
	if(month==null || month.equals("")){
		 month=dao.getNewMonth("CS_CUST_PHOTO_REV_MON");
	}
	String areaCode="0000";
	 ...
	 List<Map<String, Object>> monList=dao.getSelectMon("CS_CUST_PHOTO_REV_MON");
	 List<Map<String, Object>> prodTypeList=dao.getSelectProdTypePhoto("CS_CUST_PHOTO_REV_MON");
	 String parameters=dao.getParameters("30004");
%>
<head>
...
<script type="text/javascript" src="custPhotoRev_Mon.js"></script>