...
<% 
	...
	if(month==null || month.equals("")){
		 month=dao.getNewMonthGov("ST_CUST_ZHENGQI_INFO");
	}
	 String areaCode="0000";
	 String zoneCode = request.getParameter("zoneCode")==null?areaCode:(String)request.getParameter("zoneCode");
	// String selectCol = request.getParameter("selectCol")==null?"NUM13":(String)request.getParameter("selectCol");
	 List<Map<String, Object>> monList=dao.getSelectMonGov("ST_CUST_ZHENGQI_INFO");
	 String parameters=dao.getParameters("30017");
%>
<head>
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/governmentTelService_Mon.xls" />
...
<script type="text/javascript" src="governmentTelService_Mon.js"></script>