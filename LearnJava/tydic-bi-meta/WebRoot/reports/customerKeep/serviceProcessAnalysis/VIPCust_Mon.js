...
var  tableHead="<tr>"
	...
	//+"<td nowrap bgcolor='#cde5fd'  colspan='3'><span class='title'>VIP尊享客户端到达客户数</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  colspan='3'><span class='title'>实有VIP客户数</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  colspan='3'><span class='title'>升级客户数</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  colspan='3'><span class='title'>降级客户数</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  colspan='3'><span class='title'>离网客户数</span></td>"
	+"</tr><tr>"
	/*+"<td bgcolor='#cde5fd'><span class='title'>累计到达客户数</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>其中：VIP会员数</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>VIP发展目标完成率</span></td>";*/
	+"<td bgcolor='#cde5fd'><span class='title'>钻石卡</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>金卡</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>银卡</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>钻石卡</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>金卡</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>银卡</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>钻石卡</span></td>"
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/VIPCust_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode+"&selectCol="+$('selectCol').value+"&menuId="+menuId;
	return parent.openTreeTab("124025"+zoneCode,"VIP客户分析汇总月报表"+"["+zoneName+"]",base+url,'top');	
}
/**
 * 
 * @param myObject
