...
var  excelHeader="";
var  tableHead="<tr>"
	+"<td nowrap bgcolor='#cde5fd' style='width:80px' rowspan='2'><span class='title'>大区</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:80px' rowspan='2'><span class='title'>分公司</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:160px' colspan='2'><span class='title'>新增积分数</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:160px' colspan='2'><span class='title'>积分余额（百万）</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:240px' colspan='3'><span class='title'>作废积分数</span></td>"
	+"</tr><tr>"
	+"<td nowrap bgcolor='#cde5fd'><span class='title'>新增消费积分</span></td>"
	+"<td nowrap bgcolor='#cde5fd'><span class='title'>新增奖励积分</span></td>"
	+"<td nowrap bgcolor='#cde5fd'><span class='title'>可兑换积分</span></td>"
	+"<td nowrap bgcolor='#cde5fd'><span class='title'>不可兑换积分</span></td>"
	+"<td nowrap bgcolor='#cde5fd'><span class='title'>有离网作废积分</span></td>"
	+"<td nowrap bgcolor='#cde5fd'><span class='title'>有过期作废积分</span></td>"
	+"<td nowrap bgcolor='#cde5fd'><span class='title'>有其他原因作废积分</span></td>"
    tableHead+="</tr>";
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/integralScore_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode+"&selectCol="+$('selectCol').value+"&menuId="+menuId;
	return parent.openTreeTab("124022"+zoneCode,"积分客户分析月报表"+"["+zoneName+"]",base+url,'top');	
}
/**
 * 
 * @param myObject
