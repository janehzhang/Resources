...
var titileInfo1=$("prodTypeCode").options[$("prodTypeCode").selectedIndex].text+"->当月值";
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/custPhotoRev_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode+"&prodTypeCode="+$('prodTypeCode').value+"&menuId="+menuId;
	return parent.openTreeTab("124019"+zoneCode,"中高端拍照用户收入保有率分析月报表"+"["+zoneName+"]",base+url,'top');	
}
/**
 * 
 * @param myObject
