...
<% 
	...
	if(month==null || month.equals("")){
		 month=dao.getNewMonth_AvgSecends();
	}
	 ...
	 List<Map<String, Object>> monList=dao.getSelectMon_AvgSecends();
%>
<head>
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	<div id="div_src" style="position: absolute; width: 100%; height:100%;z-index: 1000;top: 0px; left: 0px; background-color:#F0F0F0;color:#00000;  border:1px solid #6699cc;  overflow-y:scroll;"
	 ...
	 <form id="queryform" name="queryform">
        ...
        <input type="hidden" id="col"  name="col"  value="10"  />
        <input type="hidden" id="excelData"    name="excelData"   />
        <input type="hidden" id="excelCondition"    name="excelCondition"     />
        <input type="hidden" id="cid"  name="cid"   />
        <input type="hidden" id="cid1"  name="cid1"   />
        <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/serviceAvgSecends_Mon.xls" />
...
<script type="text/javascript" src="serviceAvgSecends_Mon.js"></script>