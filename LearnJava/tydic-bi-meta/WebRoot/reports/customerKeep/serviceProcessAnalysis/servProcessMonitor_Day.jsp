...
<% 
	...
	if(dateTime==null || dateTime.equals("")){
		dateTime=dao.getNewDay("CS_SERVICE_MONITOR_DAY");
	 ...
	 String indId = request.getParameter("indId")==null?"2":(String)request.getParameter("indId");
	 List<Map<String, Object>> prodTypeList=dao.getSelectProdType("CS_SERVICE_MONITOR_DAY");
	 List<Map<String, Object>> indList=dao.getSelectIndType("CS_SERVICE_MONITOR_DAY");
	 String parameters=dao.getParameters("30012");
...
<script type="text/javascript" src="servProcessMonitor_Day.js"></script>