...
var titileInfo1=$("selectCol").options[$("selectCol").selectedIndex].text+"->本期累计";
...
var  excelHeader="";
var  tableHead="<tr>"
	+"<td nowrap bgcolor='#cde5fd' style='width:50px' rowspan='2'><span class='title'>大区</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:50px' rowspan='2'><span class='title'>分公司</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:50px' rowspan='2'><span class='title'>可兑换积分客户数</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:50px' rowspan='2'><span class='title'>活跃积分客户数</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:50px' rowspan='2'><span class='title'>积分客户活跃率</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:500px' colspan='10'><span class='title'>积分兑换人次</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:250px' colspan='5'><span class='title'>礼品价值区间礼品兑换次数</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:100px' colspan='2'><span class='title'>积分兑换礼品次数</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:100px' rowspan='2'><span class='title'>可兑换积分总分值（百万）</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:500px' colspan='10'><span class='title'>积分兑换分值（百万）</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:100px' rowspan='2'><span class='title'>积分兑换率</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:250px' colspan='5'><span class='title'>礼品价值区间兑换积分额（百万）</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:100px' colspan='2'><span class='title'>积分兑换礼品分值</span></td>"
	+"</tr><tr>"
	+"<td bgcolor='#cde5fd' ><span class='title'>营业厅兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>10000号兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>网上营业厅兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>掌厅（wap）兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>掌厅(短信)兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>贵宾厅</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>全国积分商城</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>本省联盟商家（店面）兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>全国联盟商家（店面）兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>其他</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>0-1999分</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>2000分-4999分</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>5000分-9999分</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>10000分以上</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>其他</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>电信自营业务类</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>其他礼品类</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>营业厅兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>10000号兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>网上营业厅兑换</span></td>"
	+"<td bgcolor='#cde5fd' ><span class='title'>掌厅（wap）兑换</span></td>"
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/integralExchange_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode+"&selectCol="+$('selectCol').value+"&menuId="+menuId;
	return parent.openTreeTab("124023"+zoneCode,"积分客户分析月报表"+"["+zoneName+"]",base+url,'top');	
}
/**
 * 
 * @param myObject
...
function changeCol(obj){
	$("titleInfo1").innerHTML=$("selectCol").options[$("selectCol").selectedIndex].text+"->当月值";
	$("titleInfo2").innerHTML=$("selectCol").options[$("selectCol").selectedIndex].text+"->本期累计";
