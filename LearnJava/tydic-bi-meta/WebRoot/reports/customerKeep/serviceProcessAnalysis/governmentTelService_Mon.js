...
var  tableHead="<tr>"
	...
	+"<td nowrap bgcolor='#cde5fd'  style='width:200px' colspan='4'><span class='title'>故障下单情况</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  style='width:250px' colspan='5'><span class='title'>工作流下单情况（投诉单）</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  style='width:250px' colspan='5'><span class='title'>工作流下单情况（需求单）</span></td>"
	+"</tr><tr>"
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/governmentTelService_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode;
	return parent.openTreeTab("127003"+zoneCode,"政企属性用户来电服务月报表"+"["+zoneName+"]",base+url,'top');	
}
//指标解释
function indexExp(){
	 $('index_exp').innerHTML='';
