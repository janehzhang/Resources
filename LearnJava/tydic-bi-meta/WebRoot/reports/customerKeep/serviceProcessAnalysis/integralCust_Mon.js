...
var  tableHead="<tr>"
	...
	+"<td nowrap bgcolor='#cde5fd' style='width:80px' rowspan='3'><span class='title'>分公司</span></td>"
	+"<td nowrap bgcolor='#cde5fd'  colspan='10'><span class='title'>积分客户总数</span></td>"
	+"<td nowrap bgcolor='#cde5fd' style='width:80px' rowspan='3'><span class='title'>新增积分客户数</span></td>"
	+"<td nowrap bgcolor='#cde5fd' colspan='3'><span class='title'>有作废积分的客户数</span></td>"
	+"</tr><tr>"
	
	+"<td bgcolor='#cde5fd' style='width:640px' colspan='5'><span class='title'>可兑换积分客户数</span></td>"
	+"<td bgcolor='#cde5fd' style='width:640px' colspan='5'><span class='title'>不可兑换积分客户数</span></td>"
	+"<td bgcolor='#cde5fd' style='width:100px' rowspan='2'><span class='title'>有离网作废积分的客户数</span></td>"
	+"<td bgcolor='#cde5fd' style='width:100px' rowspan='2'><span class='title'>有过期作废积分的客户数</span></td>"
	+"<td bgcolor='#cde5fd' style='width:100px' rowspan='2'><span class='title'>有其他原因作废积分的客户数</span></td>"
	+"</tr><tr>"
	+"<td bgcolor='#cde5fd'><span class='title'>0以下</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>0-999分</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>1000-4999分</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>5000-9999分</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>10000分以上</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>0以下</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>0-999分</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>1000-4999分</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>50100%9999分</span></td>"
	+"<td bgcolor='#cde5fd'><span class='title'>10000分以上</span></td>"
    tableHead+="</tr>";
...
{	
	var url="/reports/customerKeep/serviceProcessAnalysis/integralCust_Mon.jsp?dateTime="+$("dateTime").value+"&zoneCode="
	+zoneCode+"&selectCol="+$('selectCol').value+"&menuId="+menuId;
	return parent.openTreeTab("124021"+zoneCode,"积分客户分析月报表"+"["+zoneName+"]",base+url,'top');	
}
/**
 * 
 * @param myObject
