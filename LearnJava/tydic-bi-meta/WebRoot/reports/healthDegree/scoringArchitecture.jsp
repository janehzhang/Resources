...
<%
	...
	if(month==null || month.equals("")){
		 month=dao.getMaxMonth("CS_HEALTHY_IDENTIFY");
	}
	 List<Map<String, Object>> monList=dao.getMonList("CS_HEALTHY_IDENTIFY");
%>
<head>
    ...
    <script type="text/javascript">
		function impExcel(){
		    ...
		    var queryCond="月份："+dateTime;
	   	    ...
	   	    var url = getBasePath()+"/portalCommon/module/procedure/impExcel/implExcel_ScoringArchitecture.jsp";
...
<script type="text/javascript" src="scoringArchitecture.js"></script>