...
<%@ page import="java.util.*,java.text.SimpleDateFormat,java.util.Calendar,tydic.portalCommon.DateUtil"%>
...
<% 
	 ...
	 if(week==null || week.equals("")){
		 week=dao.getMaxWeek("CS_PWD_SUB_ACTION");
	 }
	 List<Map<String, Object>> weekList=dao.getWeeksList("CS_PWD_SUB_ACTION");
	 SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd");
	 String  NowDay=  formatter.format(new Date()).replaceAll("-","");//当前日期
	 String MaxDay=week.substring(9,17);
	 long interval1=DateUtil.getInterval(NowDay,MaxDay);
	 if(interval1>0){
		 String startDate=week.substring(0,8);
		 String endDate=week.substring(9,17);
		 ...
		 String lastStart=DateUtil.lastDay(startT, -7);
		 String lastEnd=DateUtil.lastDay(endT, -7);
		 week=lastStart.replaceAll("-", "")+"~"+lastEnd.replaceAll("-", "");
		 weekList=dao.getWeeksListAtt("CS_PWD_SUB_ACTION");
	 }
%>
<head>
										...
										<tr>
										     <td>
													<table  width="750"  border="0" cellpadding="0" cellspacing="0">
													                <tr>
		<td style="width: 250px;">&nbsp;&nbsp;&nbsp;周期:
          <select id="dateTime"    name="dateTime" style="width: 200px;"> 
...
<script type="text/javascript" src="codeExceptionMonitor_Mon.js"></script>