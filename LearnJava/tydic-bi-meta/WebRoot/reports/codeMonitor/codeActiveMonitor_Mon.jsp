...
<% 
	 ...
	 if(month==null || month.equals("")){
		 month=dao.getMaxMonth("CS_PWD_SERV");
	 }
	 List<Map<String, Object>> monList=dao.getMonsList("CS_PWD_SERV");
%>
<head>
...
<script type="text/javascript" src="codeActiveMonitor_Mon.js"></script>