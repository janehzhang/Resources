...
<% 
	 String pwdType = request.getParameter("pwdType")==null?"":request.getParameter("pwdType");
	 ...
	 String filePath="/upload/excelHeader/custCodeMonitor1.xls";
...
<script type="text/javascript" src="newCodeMonitor_MonSum.js"></script>