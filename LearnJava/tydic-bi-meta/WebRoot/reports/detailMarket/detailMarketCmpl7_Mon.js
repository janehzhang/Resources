...
var excuteInitData=function(){
		 ...
		 map.zoneCode=$('zoneCode').value==""?"0000":$("zoneCode").value;
 		 map.dateType="2";//月
 		 map.rptType="7";//报表7
 		 map.cmplProdTypeId=$('cmplProdTypeId').value==""?"901":$("cmplProdTypeId").value;
 		 $('chartdiv1').innerHTML='';
	     $('chartdiv2').innerHTML='';
	     map.field1="_CMPL";
 	     dhx.showProgress("正在执行......");
 	     DetailMarketAction.queryDetailMarket3_pg(map, function (res) {
	     	   dhx.closeProgress();
	 			 if (res == null) {
	 				   dhx.alert("读取数据发生错误,请稍后重试，或者联系系统管理员!");
	 				     return;
	 			 }else{
	 				chart1=new FusionCharts(base+"/js/Charts/MSColumn2D.swf", "ChartId1_"+cid1, "100%", "230", "0", "0");
	 	 		    chart2=new FusionCharts(base+"/js/Charts/MSColumn2D.swf", "ChartId2_"+cid, "100%", "230", "0", "0");
	 	 		    chart1.setDataXML(res.barChartMap1);
		 	        chart2.setDataXML(res.barChartMap2);
...
function exportExcel(){
		    ...
		    var queryCond="月份："+startDate+"    区域："+zone; 
	   	    ...
	   	    var url = getBasePath()+"/portalCommon/module/procedure/impExcel/implExcel_upDownChartHeader.jsp";
