...
var  lookMenuHref=function(zoneName,zoneCode,indexName,indexId){
	   var dateTime=$("dateTime").value;
	   var url="/reports/customerSatisfied/broadbandRepair/noSatisfiedReason_Week.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime;
	   return parent.openTreeTab("122010"+zoneCode, "宽带修障不满意原因TOP周报"+"["+zoneName+"]", base+url, 'top');
}
/**
 *  打开链接菜单
 * 
...
{	
	...
	var url="/reports/customerSatisfied/broadbandRepair/serviceSatisfied_Week.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&menuId="+menuId;
	return parent.openTreeTab("122009"+zoneCode, "宽带修障满意率周报"+"["+zoneName+"]", base+url, 'top');
}
//通过列改变图形
