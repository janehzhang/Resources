...
var  lookMenuHref=function(zoneName,zoneCode){
	   var dateTime=$("dateTime").value;
	   var url="/reports/customerSatisfied/broadbandRepair/noSatisfiedReason_Day.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime;
	   return parent.openTreeTab("122025"+zoneCode, "宽带修障不满意原因TOP日报"+"["+zoneName+"]", base+url, 'top');
}
//钻取
...
{	
	...
	var url="/reports/customerSatisfied/broadbandRepair/serviceSatisfied_Day.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&menuId="+menuId;
	return parent.openTreeTab("122023"+zoneCode, "宽带修障满意率日报"+"["+zoneName+"]", base+url, 'top');
}
/**
 *  打开链接菜单
 * 
