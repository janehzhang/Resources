...
<%
	...
	}else if("11".equals(vTypeId)||"11".equals(vTypeId)){
		filePath="/upload/excelHeader/satisfiedDetails_Sum_11.xls";
	}else if("12".equals(vTypeId)||"12".equals(vTypeId)){
   ...
   <div id="div_src" style="position: absolute; width: 100%; height:100%;z-index: 1000;top: 0px; left: 0px; background-color:#F0F0F0;color:#00000;  border:1px solid #6699cc;  overflow-y:scroll;"
	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value="<%=menuName %>" />
		...
		<input type="hidden"  id="" name="class" value="tydic.reports.customerSatisfied.CustomerSatisfiedAction" />
		<input type="hidden"  id="" name="classMethod" value="getCustomerSatisfiedDetails_Sum" />
		<input type="hidden"  id="" name="fileType" value="csv" />
...
<script type="text/javascript" src="satisfiedDetails_Sum_zyj.js"></script>