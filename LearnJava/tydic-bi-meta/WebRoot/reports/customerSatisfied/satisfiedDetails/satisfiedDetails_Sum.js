...
function buildHeader(){
	var tableHead="";
	if(vTypeId=='5'||vTypeId=='8'){	
		    tableHead="<tr>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>大区</span></td>"
			...
			+"<td bgcolor='#cde5fd' colspan='6' style='width:30%'><span class='title'>测评满意率</span></td>"
			...
			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>不满意原因排名</span></td>"
			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>更多维度分析</span></td>"
			+"</tr>"
			+"<tr>"
	        ...
	        tableHead+="</tr>";}
					...
					+"<td bgcolor='#cde5fd' colspan='6' style='width:300px'><span class='title'>测评满意率</span></td>"
					+"<td bgcolor='#cde5fd' style='width:50px' rowspan='2'><span class='title'>测评满意数</span></td>"
					+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>不满意原因提及率</span></td>"
					+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>不满意原因提及数</span></td>"
					+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>不满意原因排名</span></td>"
	        	...
	        	tableHead="<tr>"
	    			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>大区</span></td>"
	    			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>分公司</span></td>"
	    			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>综合满意率</span></td>"
	    			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>应测评总数</span></td>"
	    			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>邀请客户数</span></td>"
	    			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>使用率</span></td>"
	    			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>测评有效样本数</span></td>"
	    			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>测评参与率</span></td>"
	    			+"<td nowrap bgcolor='#cde5fd' colspan='3' style='width:150px'><span class='title'>总体评价</span></td>"
	    			+"<td bgcolor='#cde5fd' colspan='6' style='width:300px'><span class='title'>测评满意率</span></td>"
	    			...
	    			+"<tr>"
					+"<td bgcolor='#cde5fd'><span class='title'>满意</span></td>"
					+"<td bgcolor='#cde5fd'><span class='title'>一般</span></td>"
					+"<td bgcolor='#cde5fd'><span class='title'>不满意</span></td>"
					+"<td bgcolor='#cde5fd'><span class='title'>当期</span></td>"
					+"<td bgcolor='#cde5fd'><span class='title'>环比</span></td>"
					+"<td bgcolor='#cde5fd'><span class='title'>同比</span></td>"
			        ...
			        tableHead="<tr>"
						...
						+"<tr>"
						+"<td bgcolor='#cde5fd'><span class='title'>满意</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>一般满意</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>不满意</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>无法评价</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>当期</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>环比</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>同比</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>平均</span></td>"
			        ...
			        tableHead="<tr>"
						...
						+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>测评有效样本数</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>测评参与率</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:100px'><span class='title'>VIP客户经理拨打客户电话真实情况</span></td>"
						+"<td bgcolor='#cde5fd' colspan='5' style='width:300px'><span class='title'>总体评价</span></td>"
						+"<td bgcolor='#cde5fd' colspan='6' style='width:300px'><span class='title'>测评分数</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>更多维度分析</span></td>"
						+"</tr>"
						+"<tr>"
						+"<td bgcolor='#cde5fd'><span class='title'>VIP客户经理拨打客户电话</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>联系客户真实率</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>1分</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>2分</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>3分</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>4分</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>5分</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>平均分</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>环比</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>同比</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>满意率</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>片区排名</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>全省排名</span></td>";
				        tableHead+="</tr>";
		        }
			   
			   else if(vTypeId=='11'||vTypeId=='13'){
			        tableHead="<tr>"
						+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>大区</span></td>"
						+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>分公司</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>邀请客户数</span></td>"
						...
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:150px'><span class='title'>用户反馈可正常使用占比</span></td>"
						...
						+"</tr>"
						+"<tr>"
						+"<td bgcolor='#cde5fd'><span class='title'>不能正常使用</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>可正常使用</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>非常满意</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>满意</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>不满意</span></td>"
			        ...
			        tableHead="<tr>"
						+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>大区</span></td>"
						+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>分公司</span></td>"
						+"<td bgcolor='#cde5fd' colspan='4' style='width:300px'><span class='title'>邀请客户数</span></td>"
						+"<td bgcolor='#cde5fd' colspan='4' style='width:300px'><span class='title'>测评有效样本数</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>测评参与率</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='3' style='width:150px'><span class='title'>总体评价</span></td>"
						+"<td bgcolor='#cde5fd' colspan='6' style='width:300px'><span class='title'>测评满意率</span></td>"
						+"<td bgcolor='#cde5fd' style='width:50px' rowspan='2'><span class='title'>测评满意数</span></td>"
						...
						+"</tr>"
						+"<tr>"
						+"<td bgcolor='#cde5fd'><span class='title'>总数</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>未接入</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>未评价</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>不满意评价</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>总数</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>未接入</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>未评价</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>不满意评价</span></td>"
			        ...
			        tableHead="<tr>"
						+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:10px'><span class='title'>片区</span></td>"
						+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:20px'><span class='title'>分公司</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2'  style='width:10px'><span class='title'>邀请客户数</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2'  style='width:10px'><span class='title'>参与测评客户数</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' style='width:10px'><span class='title'>测评参与率</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='3' style='width:30px'><span class='title'>总体评价数量</span></td>"
						+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:10px'><span class='title'>测评满意数</span></td>"
						+"<td bgcolor='#cde5fd' colspan='6' style='width:60px'><span class='title'>测评满意率</span></td>"
						+"<td bgcolor='#cde5fd' style='width:10px' rowspan='2'><span class='title'>不满意数量</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' style='width:10px'><span class='title'>不满意原因提及率</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:20px'><span class='title'>1-排队等候时间过长</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:20px'><span class='title'>2-业务办理时间过长</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:20px'><span class='title'>3-人员服务态度差</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:20px'><span class='title'>4-营业厅整体环境不好</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:20px'><span class='title'>5-营业员解释不清楚</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:20px'><span class='title'>6-业务办理有差错</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:20px'><span class='title'>7-业务规则不满意</span></td>"
						+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:20px'><span class='title'>8-其他</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' style='width:10px'><span class='title'>更多维度分析</span></td>"
						+"</tr>"
						+"<tr>"
						+"<td bgcolor='#cde5fd'><span class='title'>非常满意</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>满意</span></td>"
						...
						+"<td bgcolor='#cde5fd'><span class='title'>片区排名</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>全省排名</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>提及数</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>提及率</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>提及数</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>提及率</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>提及数</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>提及率</span></td>"
...
var queryData=function(){
    ...
    CustomerSatisfiedAction.getCustomerSatisfiedDetails_Sum(map, function (res) {
    	$('chartdiv1').innerHTML='';
    	$('chartdiv2').innerHTML='';
   	               dhx.closeProgress();
				        if (res == null) {
			    		     ...
			    		     for(var j=0;j<headColumn.length;j++)
			    		      {
			    		               ...
			    		               if(tempColumn.indexOf('_')==-1)
					    		       {
			    		            	   ...
			    		            	   }else if(tempColumn=='测评满意数'||tempColumn=='拨打电话量'){
			    		            	   ...
			    		            	   }else if(tempColumn=='无法评价'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','107')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='一分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','1')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='二分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','2')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='三分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','3')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='四分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','4')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='五分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','5')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else{
			    		            	       tableData +="<td nowrap align='center'>"+addWaringStyle(dataColumn[i][tempColumn], null ,tempColumn)+"</td>";
			    		            	   }
					    		             excelData += dataColumn[i][tempColumn]+"}";
			    		            	   ...
			    		            	   if(tempColumn=='不满意原因排名'){
			    		            		...
			    		            		tableData +="<td nowrap align='center' onclick=\"goMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','3')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            		 ...
			    		            		 tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','103')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            		   ...
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','107')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='一分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','1')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='二分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','2')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='三分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','3')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='四分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','4')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='五分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','5')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else{
			    		            	       tableData +="<td nowrap align='center'>"+addWaringStyle(dataColumn[i][tempColumn], null ,tempColumn)+"</td>";
			    		            	   }
					    		             excelData += dataColumn[i][tempColumn]+"}";
		    	  ...
		    	  for(var j=0;j<headColumn.length;j++)
	   		        {
	   		               ...
	   		               if(tempColumn.indexOf('_')==-1)
			    		       {
	   		            	   if(tempColumn=='不满意原因排名'){
	   		            	      tableData+="<td nowrap align='center' onclick=\"lookMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>";  
	   		            	   }else if(tempColumn=='更多维度分析'){
			    		     ...
			    		     for(var j=0;j<headColumn.length;j++)
			    		      {
			    		               ...
			    		               if(tempColumn.indexOf('_')==-1)
					    		       {
			    		            	   if(tempColumn=='不满意原因排名'){
			    		            		   ...
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','0')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='受理量'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','5')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='测评有效样本数'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','1')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='测评满意数'||tempColumn=='拨打电话量'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','2')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='不满意量'){
			    		            		tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','3')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='对客户代表不满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','1')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='对其他不满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','2')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='非常满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','101')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='比较满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','102')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='不满意'){
			    		            		 tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','103')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='一般满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','104')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='不能正常使用'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','105')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='可正常使用'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','106')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='无法评价'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','107')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='一分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','1')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='二分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','2')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='三分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','3')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='四分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','4')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='五分'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','5')\" class='unl'>"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else{
			    		            	       tableData +="<td nowrap align='center'>"+addWaringStyle(dataColumn[i][tempColumn], null ,tempColumn)+"</td>";
			    		            	   }
					    		             excelData += dataColumn[i][tempColumn]+"}";
...
var  goMenuHref=function(zoneName,zoneCode,vTypeId,indexId){
	   ...
	   endTime =endTime.substr(0,4)+"-"+endTime.substr(4,2)+"-"+endTime.substr(6,2) ;
		  ...
		  if(vTypeId=='0'){//0宽带新装
			 ...
			 tab_name="实体渠道";
		  }if(vTypeId=='300'){//2营业厅服务
				 url="/portalCommon/module/procedure/visitDetail/wx/ADSL_visitList.jsp?zoneCode="+zoneCode+
				  "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId+"&actType=300";
				 tab_name="微信";
	        ...
	        tab_name="非实体渠道";
			 ...
			 tab_name="实体渠道评价器";
			  ...
			  "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId;
			  tab_name="宽带IVR修障";
		 }if(vTypeId=='13'){//13光宽新装
			 if(rptId=='1'){
				  url="/portalCommon/module/procedure/visitDetail/ADSL_visitList_gk_zyj.jsp?zoneCode="+zoneCode+
				  "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId+"&ripId=13"+"&rptId=1";
				  tab_name="光宽装移";
			  }
			  if(rptId=='3'){
				  url="/portalCommon/module/procedure/visitDetail/ADSL_visitList_gk_zyj.jsp?zoneCode="+zoneCode+
				  "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId+"&ripId=13"+"&rptId=3";
				  tab_name="光宽移机";
			  }
			  if(rptId=='4'){
				  url="/portalCommon/module/procedure/visitDetail/ADSL_visitList_gk_zyj.jsp?zoneCode="+zoneCode+
				  "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId+"&ripId=13"+"&rptId=4";
				  tab_name="光宽新装";
			  }
		  }if(vTypeId=='14'){//14光宽修障
			  url="/portalCommon/module/procedure/visitDetail/update/ADSL_visitUpdateList_gk_xz.jsp?zoneCode="+zoneCode+
			  "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId+"&ripId=14";
			  tab_name="光宽修障";
		 }if(vTypeId=='17'){//投诉满意度
			 url="/portalCommon/module/procedure/visitDetail/sts/ts_visitSatisfyList.jsp?zoneCode="+zoneCode+
			 "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId+"&actType=17";
			  tab_name="投诉";
		 }if(vTypeId=='18'){//vip
			 url="/portalCommon/module/procedure/visitDetail/vip/ADSL_visitList.jsp?zoneCode="+zoneCode+
			  "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId+"&actType="+vTypeId;
			  tab_name="星级客户";
		 }
...
var returnMenuHref=function(zoneName,zoneCode,reasonId){
	  ...
	  if(vTypeId=='0'){//0宽带新装
		 ...
		 if(rptId=='1'){
			  url="/portalCommon/module/procedure/visitDetail/ADSL_visitList_gk_zyj.jsp?zoneCode="+zoneCode+
			  "&startTime="+startTime+"&endTime="+endTime+"&satisType="+reasonId+"&ripId=13"+"&rptId=1";
			  tab_name="光宽装移";
		  }
		  if(rptId=='3'){
			  url="/portalCommon/module/procedure/visitDetail/ADSL_visitList_gk_zyj.jsp?zoneCode="+zoneCode+
			  "&startTime="+startTime+"&endTime="+endTime+"&satisType="+reasonId+"&ripId=13"+"&rptId=3";
			  tab_name="光宽移机";
		  }
		  if(rptId=='4'){
			  url="/portalCommon/module/procedure/visitDetail/ADSL_visitList_gk_zyj.jsp?zoneCode="+zoneCode+
			  "&startTime="+startTime+"&endTime="+endTime+"&satisType="+reasonId+"&ripId=13"+"&rptId=4";
			  tab_name="光宽新装";
		  }
	  }if(vTypeId=='14'){//14光宽修障
		  url="/portalCommon/module/procedure/visitDetail/update/ADSL_visitUpdateList_gk_xz.jsp?zoneCode="+zoneCode+
		  "&startTime="+startTime+"&endTime="+endTime+"&satisType="+reasonId+"&ripId=14";
		  tab_name="光宽修障";
	 }if(vTypeId=='17'){//投诉满意度
		 url="/portalCommon/module/procedure/visitDetail/sts/ts_visitSatisfyList.jsp?zoneCode="+zoneCode+
		 "&startTime="+startTime+"&endTime="+endTime+"&indexId="+indexId+"&actType=17";
	  ...
	  if(vTypeId=='0'){//0宽带新装
		 ...
		 url="/portalCommon/module/procedure/visitDetail/hf/ADSL_visitList.jsp?zoneCode="+zoneCode+
		  "&startTime="+startTime+"&endTime="+endTime+"&satisType="+reasonId+"&actType="+vTypeId;
			 ...
			 url="/portalCommon/module/procedure/visitDetail/wx/ADSL_visitList.jsp?zoneCode="+zoneCode+
			  "&startTime="+startTime+"&endTime="+endTime+"&satisType="+reasonId+"&actType=300";
			 tab_name="微信";
	  }if(vTypeId=='20'){//营业厅服务非实体
	  		tab_name ="非实体渠道";
	     url="/portalCommon/module/procedure/visitDetail/hf/no_ADSL_visitList.jsp?zoneCode="+zoneCode+
