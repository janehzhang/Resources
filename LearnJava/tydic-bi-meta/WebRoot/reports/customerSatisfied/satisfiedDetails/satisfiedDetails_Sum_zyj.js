...
/** Tree head **/
dwrCaller.addAutoAction("loadZoneTree","ZoneAction.queryZoneByIVRPathCenterCode");
...
dwrCaller.addAction("querySubZoneCode",function(afterCall,param){
    ...
    ZoneAction.queryIVRCenterCode(param.id,function(data){
...
function buildHeader(){
	var tableHead="";
	 if(vTypeId=='11'||vTypeId=='13'){
			        tableHead="<tr>"
						+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='height:30px'><span class='title'>分公司</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' ><span class='title'>邀请客户数</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' ><span class='title'>测评有效样本数</span></td>"
						+"<td bgcolor='#cde5fd' rowspan='2' ><span class='title'>测评参与率</span></td>"
						+"</tr>"
						+"<tr>"
						+"<td bgcolor='#cde5fd'><span class='title'>不能正常使用</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>可正常使用</span></td>"
						+"<td bgcolor='#cde5fd'><span class='title'>可正常使用率</span></td>"
						...
						+"<td bgcolor='#cde5fd'><span class='title'>测评满意率</span></td>"
				        tableHead+="</tr>";
