...
function buildHeader(){
	var tableHead="";
	 tableHead="<tr>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='3' style='width:50px'><span class='title'>地市</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='3' style='width:50px'><span class='title'>分公司</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='6'  style='width:50px'><span class='title'>待办处理条数情况</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='2' style='width:50px'><span class='title'>待办处理比例情况</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='5'style='width:50px'><span class='title'>核查情况占比</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='7' style='width:50px'><span class='title'>处理情况占比</span></td>"
			+"</tr>"
			+"<tr>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>待办发送条数</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' style='width:100px'><span class='title'>超时条数</br>（含在途和已处理）</span></td>"
			+"<td nowrap bgcolor='#cde5fd' colspan='2'   style='width:50px'><span class='title'>已处理待办单情况</span></td>"
			+"<td nowrap bgcolor='#cde5fd' colspan='2'  style='width:50px'><span class='title'>在途待办单情况</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>在途单超时占比</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>异常工单处理及时率</span></td>"
			
		
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>客户反馈属实</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>客户反馈失实</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>修障人员虚假回单</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>修障人员技能问题</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>用户原因</span></td>"
			
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>已对装维人员考核扣罚</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>已对装维人员警示教育</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>装维人员无责</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>已督促解决问题，对修障人员进行考核扣罚</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>已督促解决问题，对装机人员进行警示教育</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>已督促解决问题，对修障人员进行技能提升</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>已跟用户沟通，用户自行处理</span></td>"
			+"</tr>"
			+"<tr>"
			+"<td bgcolor='#cde5fd' style='width:80px'><span class='title'>待办已处理条数</span></td>"
			+"<td bgcolor='#cde5fd' style='width:100px'><span class='title'>其中：超时处理条数</span></td>"
			//+"<td bgcolor='#cde5fd'><span class='title'>待办未处理条数	</span></td>"
			//+"<td bgcolor='#cde5fd'><span class='title'>其中：超时未处理条数</span></td>"
			+"<td bgcolor='#cde5fd' style='width:80px'><span class='title'>待办未处理条数	</span></td>"	
			+"<td bgcolor='#cde5fd' style='width:110px'><span class='title'>其中：超时未处理条数</span></td>"
	        tableHead+="</tr>";
	return tableHead;
}
function buildHeader1(){
	...
	tableHead1="<tr>"
			...
			+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='6'  style='width:50px'><span class='title'>待办处理条数情况</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='2' style='width:50px'><span class='title'>待办处理比例情况</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='3'style='width:50px'><span class='title'>核查情况占比</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='4' style='width:50px'><span class='title'>处理情况占比</span></td>"
			+"</tr>"
			+"<tr>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>待办发送条数</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' style='width:100px'><span class='title'>超时条数</br>（含在途和已处理）</span></td>"
			...
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>客户反馈属实</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>客户反馈失实</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>非本区域管辖范围工单</span></td>"
			
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>对装维人员进行考核扣罚</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>对装维人员进行警示教育</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>装维人员无责</span></td>"
			+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>请系统根据工单实际管理单位重新推送工单待办</span></td>"
			+"</tr>"
			+"<tr>"
			+"<td bgcolor='#cde5fd' style='width:80px'><span class='title'>待办已处理条数</span></td>"
			+"<td bgcolor='#cde5fd' style='width:100px'><span class='title'>其中：超时处理条数</span></td>"
	...
	tableHead2="<tr>"
		...
		+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='6'  style='width:50px'><span class='title'>待办处理条数情况</span></td>"
		+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='2' style='width:50px'><span class='title'>待办处理比例情况</span></td>"
		+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='4'style='width:50px'><span class='title'>核查情况占比</span></td>"
		+"<td nowrap bgcolor='#cde5fd' rowspan='1' colspan='5' style='width:50px'><span class='title'>处理情况占比</span></td>"
		+"</tr>"
		+"<tr>"
		+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>待办发送条数</span></td>"
		+"<td  bgcolor='#cde5fd' rowspan='2' style='width:100px'><span class='title'>超时条数</br>（含在途和已处理）</span></td>"
		...
		+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>装维人员虚假回单</span></td>"
		+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>装维人员技能问题</span></td>"
		+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>用户原因</span></td>"
		+"<td nowrap bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>非本区域管辖范围工单</span></td>"
		
		+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>对装维人员进行考核扣罚</span></td>"
		+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>对装维人员进行警示教育</span></td>"
		+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1'style='width:50px'><span class='title'>对装维人员进行技能提升</span></td>"
		+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>已跟用户沟通，用户自行处理</span></td>"
		+"<td  bgcolor='#cde5fd' rowspan='2' colspan='1' style='width:50px'><span class='title'>请系统根据工单实际管理单位重新推送工单待办</span></td>"
		+"</tr>"
		+"<tr>"
...
var queryData=function(){
    ...
    map.rptId   =$("rptId").value; //触点名称
    map.field   =$("selectCol").value;
    map.typeId   =$("typeId").value;
    map.changeCode=changeCode;
    //dhx.showProgress("正在执行......");
    CustomerSatisfiedAction.getOaSatisfiedSum(map, function (res) {
    	$('chartdiv1').innerHTML='';
    	$('chartdiv2').innerHTML='';
   	               //dhx.closeProgress();
				        if (res == null) {
	   		               ...
	   		               if(tempColumn.indexOf('_')==-1)
			    		       {
	   		            	   if(tempColumn=='不满意原因排名'){
	   		            			tableData+="<td nowrap align='center' onclick=\"lookMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"')\" >"+dataColumn[i][tempColumn]+"</td>"
	   		            	       ...
	   		            	       tableData +="<td nowrap align='center' style='height:30px'>"+addWaringStyle(dataColumn[i][tempColumn], null ,tempColumn)+"</td>";
	   		            	   }
			    		               ...
			    		               if(tempColumn.indexOf('_')==-1)
					    		       {
			    		            	   if(tempColumn=='不满意原因排名'){
			    		            		tableData+="<td nowrap align='center' onclick=\"lookMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            		   ...
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','0')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='受理量'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','5')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='测评有效样本数'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','1')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='测评满意数'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','2')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='不满意量'){
			    		            		tableData +="<td nowrap align='center' onclick=\"goMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','3')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='对客户代表不满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','1')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='对其他不满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','2')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='非常满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','101')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='比较满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','102')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='不满意'){
			    		            		tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','103')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='一般满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','104')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='不能正常使用'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','105')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='可正常使用'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','106')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else{
...
function buildTable1(data){
	alert(111);
    tableStr ="<table  id='table1' width='150%' height='auto'  border='0' cellpadding='0' cellspacing='0' class='tab_01'>";  
		    	  ...
		    	  for(var j=0;j<headColumn.length;j++)
	   		        {
	   		               ...
	   		               if(tempColumn.indexOf('_')==-1)
			    		       {
	   		            	   if(tempColumn=='不满意原因排名'){
   	   		            			tableData+="<td nowrap align='center' onclick=\"lookMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"')\" >"+dataColumn[i][tempColumn]+"</td>"
	   		            	   }else if(tempColumn=='更多维度分析'){
			    		               ...
			    		               if(tempColumn.indexOf('_')==-1)
					    		       {
			    		            	   if(tempColumn=='不满意原因排名'){
			    		            	      tableData+="<td nowrap align='center' onclick=\"lookMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            		   ...
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','0')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='受理量'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','5')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='测评有效样本数'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','1')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='测评满意数'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','2')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='不满意量'){
			    		            		tableData +="<td nowrap align='center' onclick=\"goMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','3')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='对客户代表不满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','1')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='对其他不满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','2')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='非常满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','101')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='比较满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','102')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='不满意'){
			    		            		 tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','103')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='一般满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','104')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='不能正常使用'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','105')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='可正常使用'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref1('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','106')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else{
			    		            	       tableData +="<td nowrap align='center'>"+addWaringStyle(dataColumn[i][tempColumn], null ,tempColumn)+"</td>";
			    		            	   }
					    		             excelData += dataColumn[i][tempColumn]+"}";
...
function buildTable2(data){
    tableStr ="<table  id='table2' width='140%' height='auto'  border='0' cellpadding='0' cellspacing='0' class='tab_01'>";  
...
function tableData2(dataColumn,headColumn){
  ...
  var userCode=$("userCode").value;
  var userCodeData=$("userCodeData").value;
  //alert(dataColumn&&dataColumn.length>0);
     if(dataColumn&&dataColumn.length>0)
	    {  
	       for(var i=0;i<dataColumn.length;i++)
	       {
		    	  ...
		    	  for(var j=0;j<headColumn.length;j++)
	   		        {
	   		               ...
	   		               if(tempColumn.indexOf('_')==-1)
			    		       {
	   		            	   if(tempColumn=='不满意原因排名'){
	   		            	      tableData+="<td nowrap align='center' onclick=\"lookMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"')\" >"+dataColumn[i][tempColumn]+"</td>";  
	   		            	   }else if(tempColumn=='更多维度分析'){
	   		            		   tableData +="<td><input type='button'  onclick=\"showdiv2(this,event,'"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"')\"  class='poster_btn' style='width:40px;' value='"+dataColumn[i][tempColumn]+"'/></td>";
	   		            	   }else{
	   		            	       tableData +="<td nowrap align='center'>"+addWaringStyle(dataColumn[i][tempColumn], null ,tempColumn)+"</td>";
	   		            	   }
			    		             excelData += dataColumn[i][tempColumn]+"}";
			    		     ...
			    		     for(var j=0;j<headColumn.length;j++)
			    		      {
			    		               ...
			    		               if(tempColumn.indexOf('_')==-1)
					    		       {
			    		            	  /* if(tempColumn=='不满意原因排名'){
			    		            		   ...
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','0')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='受理量'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','5')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='测评有效样本数'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','1')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='测评满意数'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','2')\" >"+dataColumn[i][tempColumn]+"</td>";
			    		            	   }else if(tempColumn=='不满意量'){
			    		            		tableData +="<td nowrap align='center' onclick=\"goMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','"+vTypeId+"','3')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='对客户代表不满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','1')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='对其他不满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','2')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='非常满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','101')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='比较满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','102')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='不满意'){
			    		            		 tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','103')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='一般满意'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','104')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='不能正常使用'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','105')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else if(tempColumn=='可正常使用'){
			    		            		   tableData +="<td nowrap align='center' onclick=\"returnMenuHref2('"+dataColumn[i].分公司+"','"+dataColumn[i].分公司_编码+"','106')\" >"+dataColumn[i][tempColumn]+"</td>"; 
			    		            	   }else{
			    		            	       tableData +="<td nowrap align='center'>"+addWaringStyle(dataColumn[i][tempColumn], null ,tempColumn)+"</td>";
			    		            	   }*/
					    		             excelData += dataColumn[i][tempColumn]+"}";
