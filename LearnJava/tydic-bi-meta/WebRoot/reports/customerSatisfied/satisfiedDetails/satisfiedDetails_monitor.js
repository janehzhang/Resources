...
function buildHeader(){
	...
	/* 
	 * 日期,大区,地市,分公司,营服中心,测评体系,是否异常(邀请量),异常判断结果,是否异常(参评率),异常判断结果,是否异常(满意率),异常判断结果
	 */
	
	tableHead="<tr>"
		+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>日期</span></td>"
		...
		+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>测评体系</span></td>"
		
		+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:150px'><span class='title'>邀请量</span></td>"
		+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:150px'><span class='title'>参评率</span></td>"
		+"<td bgcolor='#cde5fd' colspan='2' style='width:150px'><span class='title'>满意率</span></td>"
		+"</tr>"
		+"<tr>"
		+"<td bgcolor='#cde5fd'><span class='title'>是否异常</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>异常判断结果</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>是否异常</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>异常判断结果</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>是否异常</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>异常判断结果</span></td>"
...
var queryData2=function(){
   ...
   // map.rptId="kdzyj";
    ...
    map.changeCode=changeCode;
    dhx.showProgress("正在执行......");
    ADSLVisitUpdateListAction.getMonitorData(map, function (res) {
...
function excuteInitData(){				//page.js里面上一页下一页触发此事件
	$("cid").value=Math.random();
	var cid=$("cid").value;
	$("cid1").value=Math.random();
	var cid1=$("cid1").value;
...
function buildTable2(data){
    ...
    $("totalCount").value=data.allPageCount;		//页数
    page.buildPage(data.allPageCount , 1);			//调用公共分页函数page.js
}
/**
*  构造表头
