...
<%
	String filePath="";
	String vTypeId=(String)request.getParameter("vTypeId")==null?"":(String)request.getParameter("vTypeId");
	String rptId=(String)request.getParameter("rptId")==null?"ishop1":(String)request.getParameter("rptId");
	
	//if("9".equals(vTypeId)&&"8".equals(vTypeId)) {
	...
	if(week==null || week.equals("")){
	    week=dao.getMaxDateTime_CustomerSatisfiedSum("1","9").replaceAll("_","~");
	}else{
    	 clickTab="tab2";
  	}
	List<Map<String, Object>> weekList=dao.getDateTimeListSum("1","9");
	...
	if(startTime==null || startTime.equals("")){
			dayTime=dao.getMaxDate_EnterSum("9").substring(0,8);
	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value="<%=menuName %>" />
		...
		<tr>
			...
			<td>
			    <input type='button'  class="poster_btn"  style="display:none;width:100px;text-align:center;background:url('<%=rootPath%>/meta/resource/images/title-bg1.jpg');color:#002200" id="tab2"  name="tab2"  value="周报"    onclick="changeTab2(this);" />
			</td>
		<td> 
	    ...
	    <table width='100%'>
		  <tr>
		   ...
		   </td><td style="width:60px;"><input type='button'  class="poster_btn" id="queryBtn2"  name="queryBtn2"  value="查  询"    onclick="queryData2();"    style="width:60px;" /></td>
...
<script type="text/javascript" src="satisfiedDetails_Sum_ishop.js"></script>