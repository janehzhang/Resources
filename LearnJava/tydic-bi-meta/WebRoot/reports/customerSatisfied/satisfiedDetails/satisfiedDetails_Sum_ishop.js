...
function buildHeader(){
	var tableHead="";
	        	...
	        	tableHead="<tr>"
	    			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px';height: 50px><span class='title'>地市</span></td>"
	    			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>区县</span></td>"
	    			
	    			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>营服中心</span></td>"
	    			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>营业厅</span></td>"
	    			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>工号</span></td>"
	    			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>营业员</span></td>"
...
var queryData=function(){
    ...
    ADSLVisitUpdateListAction.getStaffSumData(map, function (res) {
    	//$('chartdiv1').innerHTML='';
    	//$('chartdiv2').innerHTML='';
   	               dhx.closeProgress();
				        if (res == null) {
