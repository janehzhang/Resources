...
<%
    String typeId =(String)request.getParameter("typeId")==null?"11":(String)request.getParameter("typeId");
    ...
    String filePath="";
    if(typeId.equals("13")||typeId=="13"){
    	filePath="/upload/excelHeader/satisfiedOaSum13.xls";
    }else if(typeId.equals("12")||typeId=="12"){
    	filePath="/upload/excelHeader/satisfiedOaSum12.xls";
    }else if(typeId.equals("11")||typeId=="11"){
    	filePath="/upload/excelHeader/satisfiedOaSum11.xls";
    }else if(typeId.equals("14")||typeId=="14"){
    	filePath="/upload/excelHeader/satisfiedOaSum14.xls";
    }else{
    	filePath="/upload/excelHeader/satisfiedOaSum.xls";
    }
...
<head>
	...
	function impExcel2(form){
			 ...
			 var zoneCode    =$("zoneCode2").value==""?"0000":$("zoneCode2").value;
   ...
   <div id="div_src" style="position: absolute; width: 100%; height:100%;z-index: 1000;top: 0px; left: 0px; background-color:#F0F0F0;color:#00000;  border:1px solid #6699cc;  overflow-y:scroll;"
	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value="<%=menuName %>" />
        ...
        <input type="hidden" value="getOaSatisfiedSum"    name="classMethod"   />
	    ...
	    <table width='100%'>
		  <tr>
		   ...
		   <!--<td style="width: 170px;">业务类型
		   		<select id="typeId" name="typeId">
		   			<option value="11">装移不满意</option>
		   			<option value="12">修障不满意</option>
		   			<option value="14">装移不能正常使用</option>
		   			<option value="13">修障未修复</option>
		   		</select>
		   </td>  -->
...
<script type="text/javascript" src="oaSatisfiedSum.js"></script>