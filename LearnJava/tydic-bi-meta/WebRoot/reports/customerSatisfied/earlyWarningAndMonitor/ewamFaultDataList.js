...
function buildHeader(){
	var tableHead="";
	 ...
	 tableHead="<tr>"
			//+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:70px'><span class='title'>时间</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:70px'><span class='title'>大区</span></td>"
			//+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:70px'><span class='title'>地市</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:70px'><span class='title'>分公司</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:70px'><span class='title'>时间</span></td>"
			+"<td nowrap bgcolor='#cde5fd' rowspan='2' style='width:70px'><span class='title'>测评体系</span></td>"
			+"<td bgcolor='#cde5fd' colspan='2' style='width:40px'><span class='title'>邀请量</span></td>"
			+"<td bgcolor='#cde5fd' colspan='2' style='width:40px'><span class='title'>参与率</span></td>"
			+"<td bgcolor='#cde5fd' colspan='2' style='width:40px'><span class='title'>满意率</span></td>"
...
//			+"<td bgcolor='#cde5fd' rowspan='2' style='width:50px'><span class='title'>不满意原因提及数</span></td>"
			+"</tr>"
			+"<tr>"
			+"<td bgcolor='#cde5fd'><span class='title'>是否异常</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>异常判定结果</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>是否异常</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>异常判定结果</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>是否异常</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>异常判定结果</span></td>"
...
//	$("titleInfo2").innerHTML=titileInfo;
    ...
    map.dateType = dateType;//日期类型--周报
    map.vTypeId = $("visitTypeId1").value;
//    map.targetId = $("targetType1").value;
    
    map.pageCount = page.pageCount;    //每页显示多少条数
    map.currPageNum=page.currPageNum;//当前第几页
    dhx.showProgress("正在执行......");
    ADSLVisitUpdateListAction.getEwamFaultDataList(map, function (res) {
    	//$('chartdiv1').innerHTML='';
    	//$('chartdiv2').innerHTML='';
   	               dhx.closeProgress();
				        if (res == null) {
...
//	$("titleInfo22").innerHTML=titileInfo;
    ...
    map.dateType = dateType;//日期类型--日报
//    map.actType   =$("vTypeId2").value; //触点名称
//    map.field   =$("selectCol2").value;
    map.vTypeId = $("visitTypeId").value;
//    map.targetId = $("targetType").value;
