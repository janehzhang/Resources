...
<head>
    ...
    <%
      ...
      String busiCode		="";
      String guid			="";
      if(orderIdStr.split("_").length==4) {
       busiCode		=orderIdStr.split("_")[2];
      
    }
    
     if(orderIdStr.split("_").length==4) {
       guid		=orderIdStr.split("_")[3];
    }
...
<body style="overflow: visible;">
   <form id="queryform" name="queryform">
        ...
        <input type="hidden" id="busiCode"    name="busiCode"   value="<%=busiCode %>"  />
...
<script type="text/javascript" src="ShowNotSatisDetail.js"></script>
