...
<%
    ...
    if(week==null || week.equals("")){
        week=dao.getMaxWeek_EveryType("1","0");//周报，宽带新装
    }
     List<Map<String, Object>> weekList=dao.getDateTimeList_EveryType("1","0");
	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="excelCondition"    name="excelCondition"     />   
	     ...
	     <td style="width: 80px;"><input type='button'  class="poster_btn" id="impBtn"    name="impBtn"    value="导  出" onclick="impExcel();"         style="width:80px;" /></td>
	     <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
