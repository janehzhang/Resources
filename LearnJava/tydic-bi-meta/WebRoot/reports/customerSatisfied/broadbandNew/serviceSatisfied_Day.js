...
var  lookMenuHref=function(zoneName,zoneCode){
	   var dateTime=$("dateTime").value;
	   var url="/reports/customerSatisfied/broadbandNew/noSatisfiedReason_Day.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime;
	   return parent.openTreeTab("122021"+zoneCode, "宽带新装不满意原因TOP日报"+"["+zoneName+"]", base+url, 'top');
}
//钻取
...
{	
	...
	var url="/reports/customerSatisfied/broadbandNew/serviceSatisfied_Day.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&menuId="+menuId;
	return parent.openTreeTab("122019"+zoneCode, "宽带新装满意率日报"+"["+zoneName+"]", base+url, 'top');
}
