...
var  lookMenuHref=function(zoneName,zoneCode){
	   var dateTime=$("dateTime").value;
	   var url="/reports/customerSatisfied/broadbandNew/noSatisfiedReason_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime;
	   return parent.openTreeTab("122020"+zoneCode, "宽带新装不满意原因TOP月报"+"["+zoneName+"]", base+url, 'top');
}
...
{	var dateTime=$("dateTime").value;
    ...
    var url="/reports/customerSatisfied/broadbandNew/serviceSatisfied_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&menuId="+menuId;
    return parent.openTreeTab("122018"+zoneCode, "宽带新装满意率月报"+"["+zoneName+"]", base+url, 'top');
}
//获得某月的最后一天
