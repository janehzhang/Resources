...
<%
    ...
    if(dateTime==null || dateTime.equals("")){
    	  ...
    	  dateTime=dao.getMaxDate_EveryTypeMod(vTypeId).substring(0,8);
										...
										<tr>
										     <td>
													<table  width="550"  border="0" cellpadding="0" cellspacing="0">
													                <tr>
													               <td width='10%'>&nbsp;&nbsp;&nbsp;日期:
           <input name="dateTime" id="dateTime" size="16" value="<%=dateTime%>"  readonly="true" class='Wdate' onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'<%=dateTime %>'})" >
           </td>
           <td width='10%'>区域:
