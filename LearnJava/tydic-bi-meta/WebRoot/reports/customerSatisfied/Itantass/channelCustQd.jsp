...
<%
	...
	if(month==null || month.equals("")){
	 ...
	 String filePath="/upload/excelHeader/channelCustQd.xls";
	 
	if (iCustCode=="1" || "1".equals(iCustCode))
    {
    	 filePath="/upload/excelHeader/channelCustQdSj.xls";
    }
    else if (iCustCode=="2" || "2".equals(iCustCode))
    {
    		 filePath="/upload/excelHeader/channelCustQdKffq.xls";
    }  
    else if (iCustCode=="4" || "4".equals(iCustCode))
    {
    		 filePath="/upload/excelHeader/channelCustQdKfdj.xls";
    }
    else if (iCustCode=="5" || "5".equals(iCustCode))
    {
    		 filePath="/upload/excelHeader/channelCustQdCzsr.xls";
    }
    else if (iCustCode=="6" || "6".equals(iCustCode))
    {
    		 filePath="/upload/excelHeader/channelCustQdZwsc.xls"; 
    }
    else if (iCustCode=="7" || "7".equals(iCustCode))
    {
    		 filePath="/upload/excelHeader/channelCustQdCplx.xls";
    }
    else if (iCustCode=="8" || "8".equals(iCustCode))
    {
    		 filePath="/upload/excelHeader/channelCustQdYhpp.xls";
    }
    else if (iCustCode=="9" || "9".equals(iCustCode))
    {
    		filePath="/upload/excelHeader/channelCustQdFffs.xls";
    }	
    else 
    {
    	filePath="/upload/excelHeader/channelCustQdXfsc.xls";
    }
...
<script type="text/javascript" src="channelCustQd.js"></script>