...
var excuteInitData=function(){
	 ...
	 map.zoneCode=$('zoneCode').value==""?"0000":$("zoneCode").value;
		 map.iChannelId = ""?"1":$("channelTypeCode").value;
		 map.iCustCode =$("iCustCode").value;
		 map.state=$('number_state').value; 		 
	     dhx.showProgress("正在执行......");
	   CustomerSatisfiedAction.channelCustService(map, function (res) {
     	   dhx.closeProgress();
 			 if (res == null) {
...
function tableHeader(headColumn){
	...
	var excelHeader="";
	var tableHead="<tr>"
		+"<td bgcolor='#cde5fd' style='width:60px'><span class='title'>"+serv_name+"</span></td>"
		+"<td bgcolor='#cde5fd' style='width:60px'><span class='title'>查询</span></td>"
		+"<td bgcolor='#cde5fd' style='width:60px'><span class='title'>充值交费</span></td>"
		+"<td bgcolor='#cde5fd' style='width:60px'><span class='title'>办理</span></td>"
		+"<td bgcolor='#cde5fd' style='width:60px'><span class='title' >咨询</span></td>"
		+"<td bgcolor='#cde5fd' style='width:60px'><span class='title'>故障申告</span></td>"
		+"<td bgcolor='#cde5fd' style='width:60px'><span class='title'>投诉</span></td>"
		+"<td bgcolor='#cde5fd' style='width:60px'><span class='title'>其他（非集团）</span></td>"
