...
<%
	...
	if(month==null || month.equals("")){
		 month=dao.getMaxMonth_NTQLITY();
	}
	 List<Map<String, Object>> monList=dao.getDateTimeList_NTQLITY();
	 String filePath="/upload/excelHeader/ItanTass.xls";
...
<script type="text/javascript" src="itanTass.js"></script>