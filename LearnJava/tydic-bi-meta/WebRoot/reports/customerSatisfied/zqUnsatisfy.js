...
function tableHeader(headColumn){
	...
	if(flag == "3" )
     ...
     if(flag == "4")
    	tableHead="<tr>"
    	+"<td bgcolor='#cde5fd' rowspan='1'><span class='title'>不满意原因</span></td>"
    	+"<td bgcolor='#cde5fd' rowspan='1'><span class='title'>不满意量</span></td>"
    	+"<td bgcolor='#cde5fd' rowspan='1'><span class='title'>排名</span></td>"
    	+"</tr>";
