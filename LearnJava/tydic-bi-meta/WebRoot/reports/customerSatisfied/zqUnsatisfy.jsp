...
<%
	...
	String flag="";
	flag=request.getParameter("flag")==null?"3":(String)request.getParameter("flag");
	 List<Map<String, Object>> weekList=dao.getDateTimeListForAll("CS_ZQMYD_AREA_RESULT","SUM_ID");
	 String filePath="";
	 if("3".equals(flag))
	 	filePath="/upload/excelHeader/noSatisfiedReason_Week.xls";
	 else filePath="/upload/excelHeader/noSatisfiedReasonSortZQ.xls";
...
<head>
    ...
    <script type="text/javascript">
		function impExcel(){
		    ...
		    var queryCond="回访时间："+dateTime+"    区域："+zone;;
...
<script type="text/javascript" src="zqUnsatisfy.js"></script>