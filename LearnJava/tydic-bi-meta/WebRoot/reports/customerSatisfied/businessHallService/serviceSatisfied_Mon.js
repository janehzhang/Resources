...
var  lookMenuHref=function(zoneName,zoneCode){
	   var dateTime=$("dateTime").value;
	   var url="/reports/customerSatisfied/businessHallService/noSatisfiedReason_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime;
	   return parent.openTreeTab("124008"+zoneCode, "营业厅服务不满意原因TOP月报"+"["+zoneName+"]", base+url, 'top');
}
...
{	var dateTime=$("dateTime").value;
    ...
    var url="/reports/customerSatisfied/businessHallService/serviceSatisfied_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&menuId="+menuId;
    return parent.openTreeTab("124007"+zoneCode, "营业厅服务满意率月报"+"["+zoneName+"]", base+url, 'top');
}
//获得某月的最后一天
