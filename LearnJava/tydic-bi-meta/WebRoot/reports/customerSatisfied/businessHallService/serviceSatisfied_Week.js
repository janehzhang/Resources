...
var  lookMenuHref=function(zoneName,zoneCode,indexName,indexId){
	   var dateTime=$("dateTime").value;
	   var url="/reports/customerSatisfied/businessHallService/noSatisfiedReason_Week.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime;
	   return parent.openTreeTab("124003"+zoneCode, "营业厅服务不满意原因TOP周报"+"["+zoneName+"]", base+url, 'top');
}
...
{	
	...
	var url="/reports/customerSatisfied/businessHallService/serviceSatisfied_Week.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&menuId="+menuId;
	return parent.openTreeTab("124002"+zoneCode, "营业厅服务满意率周报"+"["+zoneName+"]", base+url, 'top');
}
//通过列改变图形
