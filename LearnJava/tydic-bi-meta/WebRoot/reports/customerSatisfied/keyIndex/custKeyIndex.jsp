...
<%
	...
	if(month==null || month.equals("")){
		 month=dao.getMaxDateTime_CustomerSatisfiedSum("2","1");
	}
	 List<Map<String, Object>> monList=dao.getDateTimeListSum("2","1");
	 String filePath="/upload/excelHeader/custKeyIndex.xls";
...
<script type="text/javascript" src="custKeyIndex.js"></script>