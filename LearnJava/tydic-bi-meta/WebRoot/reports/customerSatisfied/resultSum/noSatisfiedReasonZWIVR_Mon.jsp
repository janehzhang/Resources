...
<%
    ...
    if(vTypeId=="11" || vTypeId.equals("11")){
        filePath="/upload/excelHeader/noSatisfiedReasonZWIVR_Week.xls";
    }else{
        filePath="/upload/excelHeader/noSatisfiedReasonXZIVR_Week.xls";
    }
...
<script type="text/javascript" src="noSatisfiedReasonZWIVR_Mon.js"></script>