...
<%
   ...
   if(vTypeId.equals("2")){
         filePath="/upload/excelHeader/serviceSatisfiedResult_Week.xls";
   }
   else if(vTypeId.equals("9")){
   		filePath="/upload/excelHeader/serviceSatisfiedResult_Week2.xls";
   }else if(vTypeId.equals("10")){
   		filePath="/upload/excelHeader/serviceSatisfiedResult_Week3.xls";
   }else if(vTypeId.equals("11")){
   		filePath="/upload/excelHeader/serviceSatisfiedResult_Week4.xls";
   }else if(vTypeId.equals("12")){
   		filePath="/upload/excelHeader/serviceSatisfiedResult_Week5.xls";
   }else if(vTypeId.equals("18")){
   		filePath="/upload/excelHeader/serviceSatisfiedResult_Week18.xls";
   }
   else{
         filePath="/upload/excelHeader/serviceSatisfiedResult_Week1.xls";
   }
...
<script type="text/javascript" src="serviceSatisfiedResult_Week.js"></script>