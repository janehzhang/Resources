...
var excuteInitData=function(){
    ...
    CustomerSatisfiedAction.getNoSatisfyResult(map, function (res) {
   	               dhx.closeProgress();
				        if (res == null) {
...
function tableHeader(headColumn){
	...
	if(vTypeId==5){
		var tableHead="<tr>"
			+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>不满意原因大类</span></td>"
			+"<td bgcolor='#cde5fd' rowspan='2'><span class='title'>不满意原因</span></td>"
			+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>不满意工单量</span></td>"
			+"<td bgcolor='#cde5fd' colspan='3'><span class='title'>不满意工单量环比</span></td>"
			+"</tr>"
			+"<tr>"
			...
			+"<td bgcolor='#cde5fd'><span class='title'>上周占比</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>本周占比</span></td>"
		...
		var tableHead="<tr>"
			+"<td bgcolor='#cde5fd'><span class='title'>不满意原因工单量排名</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>话务员姓名</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>所属地市</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>前两周</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>前一周</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>本周</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>最近三周合计</span></td>"
			tableHead+="</tr>";
	}
