...
<%
	...
	String vTypeId =(String)request.getParameter("vTypeId")==null?"5":(String)request.getParameter("vTypeId");
    ...
    String filePath="";
    if(vTypeId=="5"|| vTypeId.equals("5")){
    	filePath="/upload/excelHeader/noSatisfiedReasonResult_Week.xls";
    }
    else{
    	filePath="/upload/excelHeader/noSatisfiedReasonResult_Week1.xls";
    }
    String areaCode="0000";
    List<Map<String, Object>> weekList=dao.getDateListSum10000("1");
...
<script type="text/javascript" src="noSatisfiedReasonResult_Week.js"></script>