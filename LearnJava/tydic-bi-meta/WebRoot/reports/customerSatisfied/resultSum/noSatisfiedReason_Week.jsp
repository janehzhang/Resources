...
<%
    ...
    String filePath="";
    if("5".equals(vTypeId)||"17".equals(vTypeId)) {filePath="/upload/excelHeader/noSatisfiedReason_Week.xls";}
    else {filePath="/upload/excelHeader/noSatisfiedReason_Week.xls";}
