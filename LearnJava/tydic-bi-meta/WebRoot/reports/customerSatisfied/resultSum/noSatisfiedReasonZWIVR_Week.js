...
function tableHeader(headColumn){
	...
	if("11"==vTypeId){
		...
		+"<td bgcolor='#cde5fd' colspan='8'><span class='title'>本月工单量</span></td>"
		+"<td bgcolor='#cde5fd' colspan='8'><span class='title'>环比</span></td>"
		+"</tr>"
		+"<tr>"
		+"<td bgcolor='#cde5fd'><span class='title'>业务不能正常使用</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>安装过程长时间无人联系</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>未按约定时间上门安装</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>服务态度差</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>施工不规范</span></td>"
		+"<td bgcolor='#cde5fd'><span class='title'>多次上门才装好</span></td>"
