...
<%
    ...
    String filePath="";
    if(vTypeId=="11" || vTypeId.equals("11")){
        filePath=filePath="/upload/excelHeader/noSatisfiedReasonZWIVR_Week.xls";
    }else{
        filePath=filePath="/upload/excelHeader/noSatisfiedReasonXZIVR_Week.xls";
    }
    ...
    List<Map<String, Object>> weekList=dao.getDateListSum("1");
...
<script type="text/javascript" src="noSatisfiedReasonZWIVR_Week.js"></script>