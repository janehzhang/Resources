...
<%
	...
	if(week==null || week.equals("")){
	    week=dao.getMaxWeek_EveryType("1","3");
	}
	 List<Map<String, Object>> weekList=dao.getDateTimeList_EveryType("1","3");
	 request.setAttribute("dateTime",week);
%>
<head>
    <title>投诉处理不满意原因TOP周报</title>
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value="投诉处理不满意原因TOP周报" />
