...
var  lookMenuHref=function(zoneName,zoneCode,indexName,indexId){
	   var dateTime=$("dateTime").value;
	   var url="/reports/customerSatisfied/cmplDeal/noSatisfiedReason_Week.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime;
	   return parent.openTreeTab("124006"+zoneCode, "投诉处理不满意原因TOP周报"+"["+zoneName+"]", base+url, 'top');
}
...
{	
	...
	var url="/reports/customerSatisfied/cmplDeal/serviceSatisfied_Week.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&menuId="+menuId;
	return parent.openTreeTab("124005"+zoneCode, "投诉处理满意率周报"+"["+zoneName+"]", base+url, 'top');
}
//通过列改变图形
