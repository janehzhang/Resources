...
<%
    ...
    if(month==null || month.equals("")){
    	month=dao.getMaxWeek_EveryType("2","3");
    }
     List<Map<String, Object>> monthList=dao.getDateTimeList_EveryType("2","3");
     request.setAttribute("dateTime",month);
%>
<head>
    <title>投诉处理不满意原因TOP月报</title>
...
<body style="width: 100%;height:auto!important;overflow-y: visible;overflow-x: visible;">
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value="投诉处理不满意原因TOP月报" />
...
<script type="text/javascript" src="noSatisfiedReason_Mon.js"></script>