...
var  lookMenuHref=function(zoneName,zoneCode){
	   var dateTime=$("dateTime").value;
	   var url="/reports/customerSatisfied/cmplDeal/noSatisfiedReason_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime;
	   return parent.openTreeTab("124012"+zoneCode, "投诉处理不满意原因TOP月报"+"["+zoneName+"]", base+url, 'top');
}
...
{	var dateTime=$("dateTime").value;
    ...
    var url="/reports/customerSatisfied/cmplDeal/serviceSatisfied_Mon.jsp?zoneCode="+zoneCode+"&dateTime="+dateTime+"&selectCol="+selectCol+"&menuId="+menuId;
    return parent.openTreeTab("124011"+zoneCode, "投诉处理满意率月报"+"["+zoneName+"]", base+url, 'top');
}
//获得某月的最后一天
