...
<%@ page import="tydic.meta.module.mag.login.ILoginType" %>
<% 
...
<html>
  ...
  <body style="margin: 0px;padding: 0px;">
  	...
  	%>
    <input type="hidden" id="localCode_" value="<%=request.getParameter("localCode")==null?"":request.getParameter("localCode") %>"/>
    <input type="hidden" id="dataDateNo_" value="<%=request.getParameter("dataDateNo")==null?"":request.getParameter("dataDateNo") %>"/>
    <input type="hidden" id="title_name_" value="<%=chatAll%>"/>
    <input type="hidden" id="chartIndexCd_" value="<%=request.getParameter("chartIndexCd")==null?"":request.getParameter("chartIndexCd") %>"/>
    <input type="hidden" id="chartFieldName_" value="<%=request.getParameter("chartFieldName")==null?"":request.getParameter("chartFieldName") %>"/>
    <input type="hidden" id="userId" value="<%=id%>">
    <div id=charId_ style="width:170px;">
        <div id="_content" style="width:500px;height:100px;padding:0;marggin:0;">
            ...
            <div style="width:100%;height:20px;padding:0px;margin:0px;display: inline;" id='charRado'>
                ...
                <font size="2" style="color:black;">当日新增（户）：</font><a href="javascript:void(0)" id='YHFZ_IND_1,VALUE2,10' onclick="chartRadio(this.id)"/><font id="1" size="2" style="color:red;">移动语音</font></a>
                <a href="javascript:void(0)" id='YHFZ_IND_1,VALUE3,10' onclick="chartRadio(this.id)"/><font id="2" size="2" style="color:black;">智能机终端</font></a>
                <a href="javascript:void(0)" id='YHFZ_IND_1,VALUE4,10' onclick="chartRadio(this.id)"/><font id="3" size="2" style="color:black;">有线宽带</font></a>
                <a href="javascript:void(0)" id='YHFZ_IND_1,VALUE5,10' onclick="chartRadio(this.id)"/><font id="4" size="2" style="color:black;">其中4M以上用户</font></a>
                <br/>
                <font size="2" style="color:black;">当日到达（户）：</font><a href="javascript:void(0)" id='YHFZ_IND_4,VALUE2,10' onclick="chartRadio(this.id)"/><font id="5" size="2" style="color:black;">移动语音</font></a>
                ...
                <a href="javascript:void(0)" id='YHFZ_IND_4,VALUE4,10' onclick="chartRadio(this.id)"/><font id="KD7" size="2" style="color:black;">有线宽带</font></a>
                <a href="javascript:void(0)" id='YHFZ_IND_4,VALUE5,10' onclick="chartRadio(this.id)"/><font id="KD8" size="2" style="color:black;">其中4M以上用户</font></a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id='audit10' style='text-align: center;font-size:14px'></span>

            </div>
            <div style="width:100%;height:20px;padding:0px;margin:0px;display: none;text-align: center" align="center" id='charRado2'>
                <font size="2" style="color:black;">通话时长（万分钟）：</font>
                <a href="javascript:void(0)" id='YWLL_IND_1,VALUE2,11' onclick="chartRadio(this.id)"/><font id="" size="2" style="color:red;">移动</font></a>
                ...
                <a href="javascript:void(0)" id='YWLL_IND_2,VALUE2,11' onclick="chartRadio(this.id)"/><font id="KD1" size="2" style="color:black;">移动</font></a>
                <a href="javascript:void(0)" id='YWLL_IND_2,VALUE3,11' onclick="chartRadio(this.id)"/><font id="KD4" size="2" style="color:black;">3G终端</font></a>
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id='audit11' style='font-size:14px'></span>
            </div>
            <div style="width:100%;height:20px;padding:0px;margin:0px;display: none;text-align: center" align="center" id='charRado3'>
                <font size="2" style="color:black;">月净增（户）：</font><a href="javascript:void(0)" id='GWYH_IND_3,VALUE3,12' onclick="chartRadio(this.id)"/><font id="CW1" size="2" style="color:red;">电信</font></a>
                <a href="javascript:void(0)" id='GWYH_IND_3,VALUE4,12' onclick="chartRadio(this.id)"/><font id="GH1" size="2" style="color:black;">移动</font></a>
                <a href="javascript:void(0)" id='GWYH_IND_3,VALUE5,12' onclick="chartRadio(this.id)"/><font id="KD1" size="2" style="color:black;">联通</font></a>
                &nbsp;<font size="2" style="color:black;">月净增份额（%）：</font><a href="javascript:void(0)" id='GWYH_IND_4,VALUE3,12' onclick="chartRadio(this.id)"/><font id="KD4" size="2" style="color:black;">电信</font></a>
                <a href="javascript:void(0)" id='GWYH_IND_4,VALUE4,12' onclick="chartRadio(this.id)"/><font id="KD1" size="2" style="color:black;">移动</font></a>
                <a href="javascript:void(0)" id='GWYH_IND_4,VALUE5,12' onclick="chartRadio(this.id)"/><font id="KD4" size="2" style="color:black;">联通</font></a>
                <br/>
                <font size="2" style="color:black;">月到达（户）：</font><a href="javascript:void(0)" id='GWYH_IND_5,VALUE3,12' onclick="chartRadio(this.id)"/><font id="CW1" size="2" style="color:black;">电信</font></a>
                <a href="javascript:void(0)" id='GWYH_IND_5,VALUE4,12' onclick="chartRadio(this.id)"/><font id="GH1" size="2" style="color:black;">移动</font></a>
                <a href="javascript:void(0)" id='GWYH_IND_5,VALUE5,12' onclick="chartRadio(this.id)"/><font id="KD1" size="2" style="color:black;">联通</font></a>
                &nbsp;<font size="2" style="color:black;">月到达份额（%）：</font><a href="javascript:void(0)" id='GWYH_IND_6,VALUE3,12' onclick="chartRadio(this.id)"/><font id="KD4" size="2" style="color:black;">电信</font></a>
                <a href="javascript:void(0)" id='GWYH_IND_6,VALUE4,12' onclick="chartRadio(this.id)"/><font id="KD1" size="2" style="color:black;">移动</font></a>
                <a href="javascript:void(0)" id='GWYH_IND_6,VALUE5,12' onclick="chartRadio(this.id)"/><font id="KD4" size="2" style="color:black;">联通</font></a>
...
//  	}
    ...
    function fcharts(chartIndexCd_,chartFieldName_,indexTypeId){
        ...
        var areaId=0;
        PortalCommonCtrlr.getDataAudit('1',indexTypeId,indexTypeId,dataNoNeed,'0000',function(res) // 以全省则只传 '0000' dataLocalCode
        {
...
//                    $('audit'+indexTypeId).innerHTML = dataNoNeed.toString().substring(dataNoNeed.toString().length-2,dataNoNeed.toString().length)+"号数据未审核";
                ...
                PortalCommonCtrlr.getTableChart(indexTypeId, reportLevelId, chartIndexCd_,
    ...
    function fchart1s(type,channel_type,bt_code){
        ...
        var areaId=0;
        PortalCommonCtrlr.getTableChart1(type, channel_type, bt_code,
    ...
    var getData = function(id,dataNow){
        PortalCommonCtrlr.getDataAudit('1',id,id,dataNow,'0000',function(res) // 以全省则只传 '0000' dataLocalCode
		{
			if(res && parseInt(res[0])==0)
			{
				return true;
                        ...
                        LoginAction.login({uid:<%=id%>},"oa",function(data){
                            switch(data){
                                ...
                                case "USER_TIP_MODIFY_PASS":{
                                    dhx.alert("你已超过八十天未修改密码,超过90天我们将强制修改");
                                    setTimeout(function(){
                                        window.location.href="<%=request.getContextPath() %>/meta/module/index/index.jsp";
                                    },2000);
                                    break;
