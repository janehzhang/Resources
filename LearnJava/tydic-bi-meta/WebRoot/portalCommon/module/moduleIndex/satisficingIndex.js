...
//var dateTime= $("dateTime").value;
 //定义另外的函数方法
dwrCaller.addAutoAction("queryAllSubMenu","ChannelIndexAction.queryAllSubMenu","119005",user.userId);
//执行这个方法
	 ...
	 if(data){
	    ...
	    var menuName="";
	 	 ...
	 	 for(var i=0;i<data.length;i++){
	 	  str +="<li class='line'><a href='#' menuName="+data[i].MENU_NAME+" menuId="+data[i].MENU_ID+"><img src="+data[i].IMG_URL+" width='94' height='94' /><p>"+data[i].MENU_NAME+"</p></a></li>";
	 	 	if(i==0){
