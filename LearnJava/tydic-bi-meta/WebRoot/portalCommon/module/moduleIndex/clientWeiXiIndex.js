...
//var dateTime= $("dateTime").value;
 //定义另外的函数方法
dwrCaller.addAutoAction("queryAllSubMenu","ChannelIndexAction.queryAllSubMenu","116041",user.userId);
...
function subMenuDataNo(menuId,menuName){
 	...
 	if(res.length>0){
		 ...
		 for(var k=0;k<res.length;k++){
			...
			if(res[k].ARRT==5){
			    str5+='<td><img src="images/home1_r10_c8.jpg" width="12" height="12" /><a href="#" class="td_class" sub2MenuName='+res[k].MENU_NAME+' menuUrl='+res[k].MENU_URL+' sub2MenuID='+res[k].MENU_ID+'>'+res[k].MENU_NAME+'</a></td>';  
			}
			if(res[k].ARRT==6){
			    str6+='<td><img src="images/home1_r10_c8.jpg" width="12" height="12" /><a href="#" class="td_class" sub2MenuName='+res[k].MENU_NAME+' menuUrl='+res[k].MENU_URL+' sub2MenuID='+res[k].MENU_ID+'>'+res[k].MENU_NAME+'</a></td>';  
			}									 
		  }
		  str1+="</tr>";
		  str2+="</tr>";
		  ...
		  str=str0+str1+str2+str3+str4+str5+str6;
	  }	
