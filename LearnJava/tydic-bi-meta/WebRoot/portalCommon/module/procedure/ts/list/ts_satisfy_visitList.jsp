...
<head>
    ...
    <%
	  ...
	  notSatisType2=(notSatisType2==null||"".equals(notSatisType2)||notSatisType2=="Â Â ")?"":notSatisType2;
      ...
      else
      {
    	 ...
    	 String dayTime=dao.getNewDay("TS_STATISFY_STATIC_RESULT");//宽带装移机
...
<body style="overflow: visible;">
   <form id="queryform" name="queryform">
        ...
        <input type="hidden" value="tsSatisfyVisitDetails"    name="classMethod"   />
...
<script type="text/javascript" src="ts_satisfy_visitList.js"></script>