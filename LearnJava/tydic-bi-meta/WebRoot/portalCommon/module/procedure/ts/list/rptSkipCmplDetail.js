...
var excuteInitData=function(){
     ...
     map.prodType      =$("prodTypeCode").value==""?prodType:$("prodTypeCode").value;
     map.businessType  =$("businessType").value;
     map.reasonType    =$("reasonType").value;
     ...
     RptSkipCmplDetailAction.getTableData(map, function (res) {
    	               dhx.closeProgress();
				        if (res == null) {
