...
<body style="overflow: visible;">
   <form id="queryform" name="queryform">
        ...
        <input type="hidden" id="dataType" name="dataType"   value="2"/> <!-- 工信部申诉月监测 -->
...
<script type="text/javascript">
	function impExcel(){
		    ...
		    var  totalCount=$("totalCount").value;//文本框
...
<script type="text/javascript" src="cmplGxbDetail.js"></script>