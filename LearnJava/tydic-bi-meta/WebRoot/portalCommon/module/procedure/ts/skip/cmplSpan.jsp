<%@page language="java" import="java.util.*,java.text.SimpleDateFormat,
                                ...
                                tydic.portalCommon.procedure.ts.skip.CmplSpanMonAction"  pageEncoding="UTF-8"%>
...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/dwr/interface/CmplSpanMonAction.js"></script>
    ...
    <%
      CmplSpanMonAction action=new CmplSpanMonAction();
...
<script type="text/javascript" src="cmplSpan.js"></script>