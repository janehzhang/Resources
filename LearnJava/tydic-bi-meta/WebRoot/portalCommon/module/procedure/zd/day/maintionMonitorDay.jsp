<%@page language="java" import="java.util.*,java.text.SimpleDateFormat,java.util.Calendar,tydic.meta.common.DateUtil,tydic.portalCommon.procedure.zd.day.MaintionMonitorDayAction,tydic.portalCommon.procedure.zd.day.MaintionMonitorDayDAO"  pageEncoding="UTF-8"%>
...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/dwr/interface/MaintionMonitorDayAction.js"></script>
    ...
    <%
      ...
      **/
      MaintionMonitorDayAction action= new MaintionMonitorDayAction();
      String  monthEndNextDay=action.getNewDate().substring(0,10);
      monthEndNextDay =(String)request.getParameter("dateTime")==null?monthEndNextDay:(String)request.getParameter("dateTime");	
      ...
      MaintionMonitorDayDAO dao = new MaintionMonitorDayDAO();
						...
						<td valign="top" width="100%">
							   <table style='border: 1px solid #87CEFF;' width='100%'  border='0'  cellpadding='0px' cellspacing='0px'>
									   <tr height='25px' style='background:url(<%=path%>/images/fpage_04.gif);'>
										...
										<tr>
										     <td>
													<table id="queryCondition" width="1050"  border="0" cellpadding="0" cellspacing="0">
										               <tr>
										                  <td width="4%">日 期:</td>
										                  <td width="14%">
...
var   loadProdTypeSelect=function(){
	 var map=new Object();
     MaintionMonitorDayAction.getProdTypeList(map, {callback:function (res) {
				        if (res != null) {
...
<%--var   loadIndexSelect=function(){
	 var map=new Object();
     MaintionMonitorDayAction.getIndexList(map, {callback:function (res) {
				        if (res != null) {
	        	   	       for(var i=0;i<res.length;i++)
						    {
...
<script type="text/javascript" src="maintionMonitorDay.js"></script>