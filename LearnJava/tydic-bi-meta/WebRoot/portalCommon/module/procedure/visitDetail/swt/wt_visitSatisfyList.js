...
var excuteInitData=function(){
   ...
   //  map.reasonId    =$("reasonId").value;
    ...
    map.indexType   =$("indexType").value;
     ...
     WtSatisfyVistListAction.getTableData(map, function (res) {
    	               dhx.closeProgress();
				        if (res == null) {
...
var fillVisitResult=function(id,phone,date)
{
    ...
    var url=base+"/portalCommon/module/procedure/visitDetail/swt/openVisitResult.jsp?id="+id+"&phone="+phone+"&date="+date+"&name="+el.innerHTML;
