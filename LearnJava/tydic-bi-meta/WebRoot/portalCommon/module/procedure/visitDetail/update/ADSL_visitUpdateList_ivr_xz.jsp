...
<head>
    ...
    <%
      ...
      else
      {
    	 ...
    	 String dayTime=dao.getNewDay("CS_VISIT_KDXZ_AREA");//宽带修障
...
<body style="overflow: visible;">
   <form id="queryform" name="queryform">
	    ...
	    <table width='100%'  border='0' cellpadding='0px' cellspacing='0px'>
						...
						<td valign="top" width="100%">
							   <table style='border: 1px solid #87CEFF;' width='100%'  border='0'  cellpadding='0px' cellspacing='0px'>
									   <tr height='25px' style='background:url(<%=path%>/images/fpage_04.gif);'>
										...
										<tr>
										     <td>
													<table id='queryCondition' width="1400"  border="0" cellpadding="0" cellspacing="0">
											                <tr>
											                  <td width="7%">回访日期:</td>
											                  <td width="10%">
											                 ...
											                 <td width="6%">回访渠道:</td>
											                  <td width="11%">
											                          ...
											                          <option value="" <% if("".equals(visitChannel)){%>   selected="selected"  <% }%>>==请选择==</option>
											                          <option value="1" <% if("1".equals(visitChannel)){%>   selected  <% }%> >wap</option>
											                          <option value="2" <% if("2".equals(visitChannel)){%>   selected  <% }%> >微信</option>
											                          <option value="3" <% if("3".equals(visitChannel)){%>   selected="selected"  <% }%>>自动</option>
											                           <option value="4" <% if("4".equals(visitChannel)){%>   selected="selected"  <% }%>>其他</option>
 																	</select>
 																</td>
											                  <!-- 
											                  <td width="7%">不满意原因:</td>
			       ...
			       <tr>											                
		             <td>
						如需在外呼平台验证数据准确性，请参考《客服分析系统与外呼平台对数操作手册》，具体内容请点击：<a style="color: rgb(0, 102, 204); font-weight: bold; font-size: 12px; " href="#" onclick="loadOperMan();">《客服分析系统与外呼平台对数操作手册》</a>
					 </td>			
		           </tr>
	      </table>
    </form>
...
<script type="text/javascript" src="ADSL_visitUpdateList_ivr_xz.js"></script>