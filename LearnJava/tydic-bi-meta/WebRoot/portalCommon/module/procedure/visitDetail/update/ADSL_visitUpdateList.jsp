...
function dump_obj(myObject) {  
	...
	var zoneCode    =$("zoneCode").value==""?zoneCode:$("zoneCode").value;
     ...
     $("excelCondition").value=queryCond; 
	     	    ...
	     	    var url = getBasePath()+"/portalCommon/module/procedure/impExcel/selfDefine/implExcelDemensionUpdate.jsp";
  ...
  function impExcelText(form){
	  ...
	  var zoneCode    =$("zoneCode").value==""?zoneCode:$("zoneCode").value;
	     ...
	     $("excelCondition").value=queryCond;  
	     dhx.showProgress("正在执行......");
	      var url = getBasePath()+"/portalCommon/module/procedure/impExcel/ADSL_visit_update_List_implTxt.jsp";
			document.forms[0].method = "post";
			document.forms[0].action=url;
			document.forms[0].target="hiddenFrame";
			document.forms[0].submit();
...
<script type="text/javascript" src="ADSL_visitUpdateList.js"></script>