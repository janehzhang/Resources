...
var excuteInitData=function(){
    ...
    map.indexType   =$("indexType").value;
     ...
     SatisfyVistListAction.getTableData(map, function (res) {
    	               dhx.closeProgress();
				        if (res == null) {
...
var fillVisitResult=function(phone, date)
{
    ...
    var url=base+"/portalCommon/module/procedure/visitDetail/s10000/openVisitResult.jsp?phone="+phone+"&date="+date+"&name="+el.innerHTML;
