...
<head>
    ...
    <%
      ...
      List<Map<String, Object>> weekList=dao.getDateTimeListForAll("CS_ZQMYD_VISIT_RESULT","SUM_ID");
										...
										<tr>
										     <td>
													<table id='queryCondition' width="1300px"  border="0" cellpadding="0" cellspacing="0">
											                <tr>
											                  <tr>
											                  <td style="width: 240px;">&nbsp;&nbsp;&nbsp;回访时间:
                                                                 <select id="startTime"    name="startTime" style="width: 160px;">
											                  ...
											                  <td width="11%">
											                          ...
											                          <option value="1" <% if("1".equals(visitChannel)){%>   selected="selected"  <% }%>>自动回访</option>
											                          <option value="2" <% if("2".equals(visitChannel)){%>   selected="selected"  <% }%>>微信回访</option>
 																	</select>
 																</td>
											                  ...
											                  <td style="display: none" width="6%">满意度:</td>
											                  <td style="display: none" width="6%">
...
function dump_obj(myObject) {  
	...
	function impExcel(form){
    			 ...
    			 var queryCond="回访时间："+startTime+"    区域："+zone;
...
<script type="text/javascript" src="zqSatisfyList.js"></script>