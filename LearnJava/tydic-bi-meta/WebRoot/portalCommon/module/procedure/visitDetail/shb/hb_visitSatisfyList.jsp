...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/dwr/interface/HbSatisfyVistListAction.js"></script>
    ...
    <%
      ...
      else
      {
    	 ...
    	 String dayTime=dao.getNewDay("CS_VISIT_HB_AREA");//号百
...
function dump_obj(myObject) {  
	...
	function impExcel(form){
     		...
     		$("excelCondition").value=queryCond; 
	     	    ...
	     	    var url =   getBasePath()+"/portalCommon/module/procedure/impExcel/selfDefine/implExcelDemensionHb.jsp";
		...
		function impExcelText(form){
     		...
     		$("excelCondition").value=queryCond; 
	     	    dhx.showProgress("正在执行......");
	     	    var url =   getBasePath()+"/portalCommon/module/procedure/impExcel/ADSL_visit_HB_List_implTxt.jsp";
				document.forms[0].method = "post";
				document.forms[0].action=url;
				document.forms[0].target="hiddenFrame";
				document.forms[0].submit();
...
<script type="text/javascript" src="hb_visitSatisfyList.js"></script>