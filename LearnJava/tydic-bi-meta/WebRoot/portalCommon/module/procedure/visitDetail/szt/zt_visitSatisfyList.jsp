...
<head>
    ...
    <script type="text/javascript" src="<%=path%>/dwr/interface/ZtSatisfyVistListAction.js"></script>
    ...
    <%
      ...
      else
      {
    	 ...
    	 String dayTime=dao.getNewDay("CS_VISIT_ZT_AREA");//掌厅
											                ...
											                <tr>
											                 ...
											                 <td width="6%">指标类型:</td>
											                  ...
											                  <td width="6%">
											                          ...
											                          <option value="103" <% if("103".equals(satisType)){%>  selected="selected"  <% }%>>不满意</option>
...
function dump_obj(myObject) {  
	...
	function impExcel(form){
	     	    ...
	     	    var url =   getBasePath()+"/portalCommon/module/procedure/impExcel/selfDefine/implExcelDemensionZt.jsp";
			...
			function impExcelText(form){
                 ...
                 $("excelCondition").value=queryCond; 
	     	    dhx.showProgress("正在执行......");
	     	    var url =   getBasePath()+"/portalCommon/module/procedure/impExcel/ADSL_visit_ZT_List_implTxt.jsp";
				document.forms[0].method = "post";
				document.forms[0].action=url;
				document.forms[0].target="hiddenFrame";
				document.forms[0].submit();
...
<script type="text/javascript" src="zt_visitSatisfyList.js"></script>