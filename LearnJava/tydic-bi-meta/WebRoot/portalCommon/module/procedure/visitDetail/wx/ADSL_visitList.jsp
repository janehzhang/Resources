    ...
    <%
	 ...
	 // System.out.println(excelTitle);
      ...
      else
      {
    	 ...
    	 String dayTime=dao.getNewDay("CS_VISIT_DX_AREA");//实体渠道短信
											                ...
											                <tr>
											                 ...
											                 --%><td width="8%">满意度:</td>
											                  <td width="6%">
											                          ...
											                          <option value="104" <% if("104".equals(satisType)){%>   selected  <% }%> >满意</option>
											                          <option value="103" <% if("103".equals(satisType)){%>   selected  <% }%> >不满意</option>
											                      <!--    <option value="1" <% if("1".equals(satisType)){%>   selected  <% }%> >排队等候时间过长</option>
											                          <option value="2" <% if("2".equals(satisType)){%>   selected  <% }%> >业务办理时间过长</option>
											                          <option value="3" <% if("3".equals(satisType)){%>   selected  <% }%> >人员服务态度差</option>
											                          <option value="4" <% if("4".equals(satisType)){%>   selected  <% }%> >营业厅整体环境不好</option>
											                          <option value="5" <% if("5".equals(satisType)){%>   selected  <% }%> >营业员解释不清楚</option>
											                          <option value="6" <% if("6".equals(satisType)){%>   selected  <% }%> >业务办理有差错</option>
											                          <option value="7" <% if("7".equals(satisType)){%>   selected  <% }%> >业务规则不满意</option>
											                          <option value="8" <% if("8".equals(satisType)){%>   selected  <% }%> >其他</option>  --%>
											                       </select>
											                  </td>
											                  <!--
