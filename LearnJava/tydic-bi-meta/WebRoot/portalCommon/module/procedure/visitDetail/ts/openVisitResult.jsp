...
<head>
    ...
    <%
        ...
        String hjNo=        (String)request.getParameter("hjNo");
        String hfType=      new String(request.getParameter("hfType").getBytes("ISO-8859-1"), "GBK");
        String countTime=   (String)request.getParameter("countTime");
...
<body>
   <form id="form1" name="form1">
        ...
        <input type="hidden"" id="hjNo"       name="hjNo"              value="<%=hjNo %>" />
        <input type="hidden"  id="hfType"     name="hfType"         value="<%=hfType %>" />
        <input type="hidden"" id="countTime"  name="countTime"    value="<%=countTime %>" />
...
var saveInfo=function()
{
   ...
   var hjNo=$('hjNo').value;
   var hfType=$('hfType').value;
   var countTime=$('countTime').value;
   //if(name!="")
   //{
	  var map=new Object();
	  map.busiNo=busiNo;
	  ...
	  ADSLVisitListAction.updateTsVisitResult(map, function (res) {
		   dhx.closeProgress();
				        if (res == null) {
