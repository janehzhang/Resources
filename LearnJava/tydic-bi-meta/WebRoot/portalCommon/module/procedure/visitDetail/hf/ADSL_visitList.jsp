    ...
    <%
	 ...
	 // System.out.println(excelTitle);
      ...
      else
      {
    	 ...
    	 String dayTime=dao.getNewDay("CS_VISIT_BUSI_AREA");//实体渠道
											                ...
											                <tr>
											                 ...
											                 <td width="8%">满意度:</td>
											                  <td width="6%">
											                          ...
											                          <option value="104" <% if("104".equals(satisType)){%>   selected  <% }%> >一般</option>
...
function dump_obj(myObject) {  
	...
	function impExcel(form){
    			 ...
    			 var queryCond="回访日期:"+startTime+"    至:"+endTime+"    区域："+zone+"     数据类型:"+$("indexType").options[$("indexType").selectedIndex].text+"     测评方式:"+$("testMethod").options[$("testMethod").selectedIndex].text+"    满意度："+$("satisType").options[$("satisType").selectedIndex].text;
