...
<%@ page import="tydic.portalCommon.procedure.visitDetail.shb.HbSatisfyVistListAction"%>
...
<%
	   ...
	   String notSatisType2=   request.getParameter("notSatisType2");
...
try{	   
	   ...
	   paramMap.put("notSatisType2",notSatisType2);
	   ...
	   HbSatisfyVistListAction  action = new HbSatisfyVistListAction();
