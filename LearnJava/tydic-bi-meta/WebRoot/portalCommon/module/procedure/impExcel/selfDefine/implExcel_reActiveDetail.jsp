...
<%@ page import="tydic.reports.customerKeep.serviceProcessAnalysis.ServiceReActiveAction"%>
...
try{
   ...
   if(null!=condition && ""!=condition){
	...
	Map<String, Object> paramMap=new HashMap<String,Object>();
	   ...
	   ServiceReActiveAction  action = new ServiceReActiveAction();
	   ...
	   for(int  i=1; i <= pager.getTotalPage(); i++)
       {
   	   ...
   	   paramMap.put("page",pager);
	   	   Map<String, Object>  resultMap=action.expExcData(paramMap);
