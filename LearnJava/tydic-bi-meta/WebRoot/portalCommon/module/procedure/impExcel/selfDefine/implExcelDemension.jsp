...
<%@ page import="tydic.reports.customerSatisfied.CustomerSatisfiedAction"%>
...
try{
	...
	String startTime="";
	String endTime="";
	if("0".equals(dateType)){//日
		startTime=request.getParameter("startDate");
		endTime=request.getParameter("endDate");
	}if("1".equals(dateType)){//周  20131021~20131028
	    startTime=dateTime;
		endTime=dateTime;
	}if("2".equals(dateType)){//月 201310	
	    startTime=dateTime;
		endTime=dateTime;
	}
 ...
 //给excel的列头加中文字段名
	...
	Map<String, Object> paramMap=new HashMap<String,Object>();
	   ...
	   CustomerSatisfiedAction  action = new CustomerSatisfiedAction();
	   List<Map<String, Object>> dataColumn=null;
	   for(int  i=1; i <= pager.getTotalPage(); i++)
       {
   	   pager.setCurrNum(i);
   	   paramMap.put("page",pager);
	   	   Map<String, Object>  resultMap=action.expHfTxtData(paramMap);
