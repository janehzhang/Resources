...
<%@ page import="tydic.reports.channel.newChannel.NewChannelAction"%>
...
try{
	...
	String startTime=    request.getParameter("dateTime");
	   ...
	   NewChannelAction  action = new NewChannelAction();
	   ...
	   for(int  i=1; i <= pager.getTotalPage(); i++)
       {
	   	   ...
	   	   Map<String, Object>  resultMap=action.expTxtDataJt(paramMap);
