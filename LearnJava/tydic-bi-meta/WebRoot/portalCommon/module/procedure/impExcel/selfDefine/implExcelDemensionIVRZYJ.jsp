...
<%@ page import="tydic.portalCommon.procedure.visitDetail.ADSLVisitListAction"%>
...
try{
    ...
    String[][] arr;
	   ...
	   ADSLVisitListAction  action = new ADSLVisitListAction();
	   ...
	   for(int  i=1; i <= pager.getTotalPage(); i++)
 {
	       ...
	       paramMap.put("page",pager);
	   	   Map<String, Object>  resultMap=action.expTxtDataIVRZYJ(paramMap);
