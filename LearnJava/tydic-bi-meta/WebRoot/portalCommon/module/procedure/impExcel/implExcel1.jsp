...
<%
	String excelName = new String(request.getParameter("excelTitle1").getBytes("ISO-8859-1"), "UTF-8");
    System.out.print(excelName);
	String excelHeader = new String(request.getParameter("excelHeader1").getBytes("ISO-8859-1"), "UTF-8");
	String excelData = new String(request.getParameter("excelData1").getBytes("ISO-8859-1"), "UTF-8");
