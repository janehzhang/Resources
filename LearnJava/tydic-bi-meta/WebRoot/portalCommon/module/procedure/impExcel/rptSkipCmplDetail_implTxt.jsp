...
<%@ page import="tydic.portalCommon.procedure.ts.list.RptSkipCmplDetailAction"%>
...
try{	   
	   ...
	   paramMap.put("prodType",prodTypeCode);
	   ...
	   RptSkipCmplDetailAction  servlet = new RptSkipCmplDetailAction();
