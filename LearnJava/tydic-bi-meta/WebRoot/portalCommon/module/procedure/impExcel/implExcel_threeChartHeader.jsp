...
<%
    ...
    // 先把读进来的图片放到一个ByteArrayOutputStream中，以便产生ByteArray   
           ...
           // 读入图片2   
            ...
            bufferImg1 = ImageIO.read(new File(chartPath+"\\linechart.png"));   
            ImageIO.write(bufferImg1, "png", byteArrayOut1);   
         // 读入图片3  
            ByteArrayOutputStream byteArrayOut2 = new ByteArrayOutputStream();   
            bufferImg2 = ImageIO.read(new File(chartPath+"\\barchart.png"));   
	...
	HSSFPatriarch patriarch = sheet.createDrawingPatriarch();   
            ...
            HSSFClientAnchor anchor2 = new HSSFClientAnchor(0, 0, 255, 255,   
                    (short) 0,16, (short) 10, 20);   
