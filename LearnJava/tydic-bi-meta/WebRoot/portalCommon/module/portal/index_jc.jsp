<%@page language="java"
	import="java.util.*,java.text.SimpleDateFormat,java.util.Calendar,tydic.meta.common.DateUtil,
                                tydic.meta.module.mag.role.RoleAction,tydic.meta.module.mag.role.RoleDAO"
	pageEncoding="UTF-8"%>
...
<script type="text/javascript"
	src="<%=rootPath%>/dwr/interface/UserAction.js"></script>
<script type="text/javascript"
	src="<%=path%>/dwr/interface/PortalCommonCtrlr.js"></script>
<script type="text/javascript"
	src="<%=path%>/dwr/interface/MenuVisitLogAction.js"></script>
<script type="text/javascript"
	src="<%=path%>/dwr/interface/ZoneAction.js"></script>
<script type="text/javascript"
	src="<%=rootPath%>/dwr/interface/SerProManageAction.js"></script>
<script type="text/javascript"
	src="<%=path%>/dwr/interface/DeptAction.js"></script>
<script type="text/javascript"
	src="<%=path%>/portal/resource/js/TableMouse.js"></script>
<script type="text/javascript"
	src="<%=path%>/portal/resource/js/formatNumber.js"></script>
<script type="text/javascript"
	src="<%=path%>/portal/resource/js/Drag.js"></script>
<script type="text/javascript" src="<%=path%>/js/Charts/FusionCharts.js"></script>
<script type="text/javascript"
	src="<%=path%>/dwr/interface/PortalInstructionAction.js"></script>
<script type="text/javascript"
	src="<%=path%>/meta/public/code.jsp?types=NOTICE_LEVEL,NOTICE_FUNCITON,IS_SHOW"></script>
<script type="text/javascript"
	src="<%=path%>/dwr/interface/ReportConfigAction.js"></script>
<script type="text/javascript"
	src="<%=path%>/js/My97DatePicker/WdatePicker.js"></script>
<script type="text/javascript" src="<%=rootPath%>/js/common/zoneTree.js"></script>
<link rel="stylesheet" type="text/css"
	href="<%=rootPath%>/css/fpage.css" />
<link rel="stylesheet" type="text/css"
	href="<%=rootPath%>/css/style01.css">
	<!-- 样 式文件 -->
	<style type="text/css">
.gonggao {
	width: auto;
...
<body style="overflow: visible;">
	<div id="div_src"
		style="position: absolute; width: 100%; height:100%;z-index: 1000;top: 0px; left: 0px; background-color:#F0F0F0;color:#00000;  border:1px solid #6699cc;  overflow-y:scroll;"
		title="" class="dragBar">
		<center
			style="color: #CCCCCC;vertical-align: middle;font-size: 24px;height: 100%;line-height:20;">数据加载中，请稍等....</center>
	</div>
	<form id="queryform" name="queryform">
		<input type="hidden" id="typeId" name="typeId" />
		<input type="hidden" id="userNameen" name="userNameen"
			value="<%=userInfo.get("userNameen").toString()%>" />
		<input type="hidden" id="defaultZoneCode" name="defaultZoneCode"
			value=<%=areaCode%> />
				...
				<td valign="top" width="16%">
					...
					<div id="left_1">
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							background="<%=path%>/images/fpage_04.gif">
							<tr>
								<td class="title_ma">地图</td>
								<td align="right"><img src="<%=path%>/images/fpage_10.gif"
									width="0px" height="25">
								</td>
							</tr>
						</table>
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
									...
									width="192px" height="180" id="myFlash"">
									<param name="allowScriptAccess" value="always" />
									<param name="movie" value="map.swf" />
									<param name="quality" value="high" />
									<embed src="map.swf" quality="high" width="192px" height="180"
										name="myFlash" allowScriptAccess="always"
					...
					<div id="left_2">
						<table width="100%" border="0" cellpadding="0" cellspacing="0"
							...
							<tr>
								...
								<td class="title_mo" align="right"><a href="#"
									onclick="openNotice(<%=systemId%>);">更多&gt;&gt;</a>
								</td>
								<td align="right"><img src="<%=path%>/images/fpage_10.gif"
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tr>
								<td align="center"><a href="#"
									onclick="openVisitRank(<%=systemId%>);"><img
										src="<%=path%>/images/access.jpg"
										style="border:0;margin-top:10px;" />
								</a>
								</td>
								<td align="center"><a href="#"
									onclick="openAppRank(<%=systemId%>);"><img
										src="<%=path%>/images/login.jpg"
										style="border:0;margin-top:10px;" />
								</a>
								</td>
							</tr>
							<tr>
								<td align="center"><a href="#"
									onclick="openVisitRank(<%=systemId%>);">用户登录情况</a>
								</td>
								<td align="center"><a href="#"
									onclick="openAppRank(<%=systemId%>);"> 用户访问情况</a>
								</td>
							</tr>
						</table>
					</div> <%
 ...
 %>
					<div id="left_3">
						...
						<ul class="u_1">
							<li class="li_1"><a href="#" onclick="openToDeal('1');"
								style="cursor:hand">待处理 <font color="red">(<span
										id="num_0"></span>)</font>
							</a>
							</li>
							<li class="li_1"><a href="#" onclick="openToDeal('2');"
								style="cursor:hand">处理中 <font color="red">(<span
										id="num_1"></span>)</font>
							</a>
							</li>
							<li class="li_1"><a href="#" onclick="openToDeal('6');"
								style="cursor:hand">待评估 <font color="red">(<span
										id="num_2"></span>)</font>
							</a>
							</li>
							<li class="li_1"><a href="#" onclick="openToDeal('5');"
								style="cursor:hand">已归档 <font color="red">(<span
										id="num_3"></span>)</font>
							</a>
							</li>
						</ul>
				...
				<td valign="top" width="84%">
					...
					<table style='margin-left:2px; border: 1px solid #87CEFF;'
						width='100%' border='0' cellpadding='0px' cellspacing='0px'>
						<tr height='25px'
							style='background:url(<%=path%>/images/fpage_04.gif);'>
							<td nowrap align='left' class='title_ma1'>查询条件</td>
						...
						<tr>
							<td>
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									<tr>
										<td width="6%">报表名称:</td>
										<td width="14%"><select id="tabId" name="tabId"
											onchange="onSelect(this);" style="display: none">
										...
										<td width="15%">
											<div id="divDay">
												<input id="dayTime" name="dayTime" value="<%=yestedayDate%>"
													readonly="true" class="Wdate"
													onclick="WdatePicker({skin:'whyGreen',dateFmt:'yyyy-MM-dd',maxDate:'<%=yestedayDate%>'})">
											</div>
										...
										<td width="5%">区 域:</td>
										<td width="15%"><input type="hidden" id="zoneCode"
											value=<%=zoneCode%> name="zoneCode" /> <input type="text"
											id="zone" name="zone"
											style="width: 160px;height:18px;line-height:18px;"
											readonly="readonly" /></td>
										<td nowrap width="7%"><input type="button"
											class="poster_btn" id="queryBtn" name="queryBtn" value="查  询"
											onclick="queryData();" style="width:60px;" /></td>
										<td width="33%"><input type='button' class="poster_btn"
											id="impBtn" name="impBtn" value="导  出" onclick="impExcel();"
											style="width:60px;" /></td>
									</tr>
								</table></td>
						</tr>
...
//全局用户数据
	...
	function impExcel(){
		        $("typeId").value=currentTab;
	     	    var url = getBasePath()+"/portalCommon/module/portal/impExcel/index_imp_excel.jsp";
...
<script type="text/javascript" src="index_jc.js"></script>