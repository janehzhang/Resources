...
dwrCaller.addAutoAction("getFaultInstallMon","StepFaultAction.getStepFaultlMon",dateTime,indexType);

/**
 * 用户页面初始化方法
 */
var indexInit=function(){
	  dwrCaller.executeAction("getFaultInstallMon",function(data){
		          if(data){
