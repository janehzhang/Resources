...
<body>
<div class="bd">
<div class="title"><img src="<%=rootPath%>/portalCommon/module/serviceControl/images/clock.png" />宽带故障申告全流程各环节管控（月报）</div>
  <div class="search">月份：
    ...
    <tr>
      <td width="418" height="48"><table width="418" border="0" cellpadding="0" cellspacing="0" background="<%=rootPath%>/portalCommon/module/serviceControl/images/title2_bg.jpg" class="f16">
        <tr>
          ...
          <td width="306" align="center" valign="middle">指标值</td>
        </tr>
      </table></td>
      <td width="108">&nbsp;</td>
    ...
    <tr>
      <td width="418" rowspan="2"><table width="418" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px #dcdcdc dashed;">
        <tr>
          ...
          <td align="right" valign="middle"><table width="275" border="0" cellpadding="0" cellspacing="0" background="<%=rootPath%>/portalCommon/module/serviceControl/images/iten_r.jpg">
              <tr>
                <td width="110" height="52" valign="middle"><div align="center">故障申告率：</div></td>
                <td width="176" align="left">当月: <span id="cmpl_num"></span><br />
                  上月: <span id="cmpl_last_num"></span></td>
              </tr>
          </table></td>
        </tr>
      </table>
          ...
          <tr>
            ...
            <td align="right" valign="middle"><table width="275" border="0" cellpadding="0" cellspacing="0" background="<%=rootPath%>/portalCommon/module/serviceControl/images/iten_r.jpg">
                <tr>
                  ...
                  <td width="176" align="left">当月: <span id="deal_num"></span><br />
                    上月: <span id="deal_last_num"></span></td>
                </tr>
            </table></td>
          </tr>
        </table>
        <table width="418" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px #dcdcdc dashed;">
          <tr>
            ...
            <td align="right" valign="middle"><table width="275" border="0" cellpadding="0" cellspacing="0" background="<%=rootPath%>/portalCommon/module/serviceControl/images/iten_r.jpg">
                <tr>
                  <td width="110" height="52" valign="middle"><div align="center">派单率：</div></td>
                  <td width="176" align="left">当月: <span id="dispach_num"></span><br />
                    上月: <span id="dispach_last_num"></span></td>
                </tr>
            </table></td>
          </tr>
        </table>
      ...
      <td width="418" rowspan="2" valign="top"><table width="418" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px #dcdcdc dashed;">
        <tr>
          ...
          <td align="right" valign="middle"><table width="275" border="0" cellpadding="0" cellspacing="0" background="<%=rootPath%>/portalCommon/module/serviceControl/images/iten_r.jpg">
              <tr>
                <td width="110" height="52" valign="middle"><div align="center">超时率：</div></td>
                <td width="176" align="left">当月: <span id="overtime_num"></span><br />
                  上月: <span id="overtime_last_num"></span></td>
              </tr>
          </table></td>
        </tr>
      </table>
        <table width="418" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px #dcdcdc dashed;">
          <tr>
            ...
            <td align="right" valign="middle"><table width="275" border="0" cellpadding="0" cellspacing="0" background="<%=rootPath%>/portalCommon/module/serviceControl/images/iten_r.jpg">
                <tr>
                  <td width="110" height="52" valign="middle"><div align="center">挂起率：</div></td>
                  <td width="176" align="left">当月: <span id="hangup_num"></span><br />
                    上月: <span id="hangup_last_num"></span></td>
                </tr>
            </table></td>
          </tr>
        </table>
        <table width="418" border="0" cellspacing="0" cellpadding="0" style="border-bottom:1px #dcdcdc dashed;">
          <tr>
            ...
            <td align="right" valign="middle"><table width="275" border="0" cellpadding="0" cellspacing="0" background="<%=rootPath%>/portalCommon/module/serviceControl/images/iten_r.jpg">
                <tr>
                  <td width="110" height="52" valign="middle"><div align="center">回访回退率：</div></td>
                  <td width="176" align="left">当月: <span id="return_num"></span><br />
                    上月: <span id="return_last_num"></span></td>
                </tr>
            </table></td>
          </tr>
        </table></td>
...
<script type="text/javascript" src="step_fault_mon.js"></script>