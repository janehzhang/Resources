...
<html>
  ...
  <form id="queryform" name="queryform">
        <input type="hidden" id="excelTitle"   name="excelTitle"    value="应用访问" />
        <input type="hidden" id="excelHeader"  name="excelHeader"   value="菜单名,菜单路径,次数,操作"/>
...
<script type="text/javascript"   src="userVisitNumRank.js"></script>
