...
var excuteInitData=function(){
     ...
     LoginLogAction.queryLoginLogByID(map, function (res) {
    	               dhx.closeProgress();
				        if (res == null) {
...
function buildTable(data){
	     tableStr ="<table  width='100%' height='auto'  border='0' cellpadding='0' cellspacing='0' class='tab_01'>";  
            tableStr +="<tr>";
                  ...
                  tableStr +="<td nowrap bgcolor='#cde5fd'><span class='title'>登录IP</span></td>";
                  tableStr +="<td nowrap bgcolor='#cde5fd'><span class='title'>登录时间</span></td>";
                  tableStr +="<td nowrap bgcolor='#cde5fd'><span class='title'>退出时间</span></td>";
            tableStr +="</tr>";
		   ...
		   tableStr +="<td  align='left'>"+data[i].USER_NAMECN+"</td>"
				     ...
				     +"<td align='left'>"+data[i].LOGIN_IP+"</td>"
				     +"<td align='left'>"+data[i].LOGIN_DATE+"</td>"
				     +"<td>"+(data[i].LOGOFF_DATE=='null'?'---':data[i].LOGOFF_DATE)+"</td>"
				  +"</tr>";
