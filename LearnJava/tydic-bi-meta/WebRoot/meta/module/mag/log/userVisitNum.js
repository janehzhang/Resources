...
var excuteInitData=function(){
     ...
     LoginLogAction.getUserVisitCount(map, function (res) {
    	               dhx.closeProgress();
				        if (res == null) {
...
function lookDetailInfo(userName) {
    ...
    var top  = 100;
    var left = 100;
    var url=base+"/meta/module/mag/log/detail/userVisitDetail.jsp?userName="+userName+"&startTime="+$('startTime').value+"&endTime="+$('endTime').value;
