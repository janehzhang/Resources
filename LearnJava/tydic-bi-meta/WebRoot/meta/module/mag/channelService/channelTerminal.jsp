	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="excelData"    name="excelData"   />
         ...
         <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/channelServiceTerminal.xls" />
...
<script type="text/javascript" src="channelTerminal.js"></script>