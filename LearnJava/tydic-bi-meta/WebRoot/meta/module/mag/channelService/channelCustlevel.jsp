...
String dateTime=(String)request.getParameter("dateTime");
   ...
   ChannelTypeDAO chanTypeDao = new ChannelTypeDAO();
	 ...
	 List<Map<String,Object>> serviceList=chanTypeDao.servicePath();
	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="excelData"    name="excelData"   />
         ...
         <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/channelServiceCustlevel.xls" />
					      ...
					      <tr>
							<td>&nbsp;&nbsp;&nbsp;月份:
					          <select id="dateTime"    name="dateTime" style="width: 80px;">
							   ...
							   <td>服务类型: </td>
							  <td> 
							  <select id="serviceType1"  name="serviceType1" style="width: 80px;">
							   <option value="0" selected>全部</option>
					           <% for(Map<String, Object> serviceKey:serviceList ){ %>
					           <option value="<%=serviceKey.get("SERV_ID") %>"><%=serviceKey.get("SERV_NAME").toString() %></option>
...
<script type="text/javascript" src="channelCustlevel.js"></script>