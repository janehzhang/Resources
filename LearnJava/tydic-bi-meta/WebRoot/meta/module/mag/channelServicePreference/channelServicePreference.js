...
var excuteInitData=function(){
	     ...
	     NewTwoChannelAction.channelServicePreferencr(map, function (res) {
	     	   dhx.closeProgress();
	 			 if (res == null) {
...
function tableHeader(headColumn){
	 tableHead="<tr>"
			...
			+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:150px'><span class='title'>服务量</span></td>"
			+"<td nowrap bgcolor='#cde5fd' colspan='2' style='width:150px'><span class='title'>用户量</span></td>"
			+"</tr>"
			+"<tr>"
			+"<td bgcolor='#cde5fd'><span class='title'>服务量</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>占比</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>用户量</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>占比</span></td>"
	        tableHead+="</tr>";
var  excelHeader="";
