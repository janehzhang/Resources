...
dwrCaller.addAutoAction("deleteOaUser","LoginLogAction.deleteOaUser");
dwrCaller.addAutoAction("insertUser","LoginLogAction.insertUser");
dwrCaller.addAutoAction("editUser","LoginLogAction.editUser");
...
var excuteInitData=function(){
     ...
     LoginLogAction.getUsersList(map, function (res) {
    	               dhx.closeProgress();
				        if (res == null) {
...
applyUser=function(){
	    ...
	    var addFormData=[
	        ...
	        {type: "block", offsetTop:15,list:[
	             {type:"input",offsetLeft:70,label:"营销中心：",inputWidth: 200,name:"zone"},
	             {type:"newcolumn"},
	             {type:"label",label:"<span style='color: red'>请选择到营销中心或者分公司</span>",offsetLeft:145}
	        ]},
	        {type:"block",offsetTop:15,list:[
...
var editUser=function(seq){
	    ...
	    var initForm=function(){
	    	LoginLogAction.getUserById(seq, function (res) {
	               dhx.closeProgress();
			        if (res == null) {
			            dhx.alert("修改失败，请重试!");
			            return;
