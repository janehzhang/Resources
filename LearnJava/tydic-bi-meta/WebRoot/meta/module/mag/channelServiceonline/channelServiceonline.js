...
//	dwrCaller.addAutoAction("loadTerminalPathPart","ChannelTypeAction.terminalPathPart");
//	
//	dwrCaller.executeAction("loadTerminalPathPart",function(data){
//      	 if(data){
//      		var selectDate="<select id='terminalType1'><option select='select' value=0>全部</option>";
//      		 data=dhx.isArray(data)?data:[data];
//      		 for(var i=0;i<data.length;i++){
//      			 selectDate+="<option value="+data[i].KEY_ID+">"+data[i].PROD_TYPE1_NAME+"</option>"; 
//      		 }
//      		selectDate+="</select>"; 
//      		$('terminalType').innerHTML=selectDate;
//      	 }
//      	 
//       });
...
var excuteInitData=function(){
	     ...
	     NewTwoChannelAction.channelServiceSix(map, function (res) {
	     	   dhx.closeProgress();
	 			 if (res == null) {
...
function tableHeader(headColumn){
	 tableHead="<tr>"
			...
			+"<td nowrap bgcolor='#cde5fd' colspan='6' style='width:150px'><span class='title'>服务量/占比</span></td>"
			+"<td nowrap bgcolor='#cde5fd' colspan='6' style='width:150px'><span class='title'>用户量/占比</span></td>"
			+"</tr>"
			+"<tr>"
			+"<td bgcolor='#cde5fd'><span class='title'>6个月内</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>6月-1年</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>1年-3年</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>3年-6年</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>6年-10年</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>10年以上</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>6个月内</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>6月-1年</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>1年-3年</span></td>"
			+"<td bgcolor='#cde5fd'><span class='title'>3年-6年</span></td>"
