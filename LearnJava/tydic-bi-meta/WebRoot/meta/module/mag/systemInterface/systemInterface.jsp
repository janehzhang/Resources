	 ...
	 <form id="queryform" name="queryform">
	   <input type="hidden" id="excelTitle"   name="excelTitle"    value=<%=menuName %> />
        ...
        <input type="hidden" id="excelData"    name="excelData"   />
         ...
         <input type="hidden" id="filePath"    name="filePath" value="/upload/excelHeader/systemMonitor.xls" />
										...
										<tr>
										     <td>
													<table  width="1050"  border="0" cellpadding="0" cellspacing="0">
													                <tr>
													                <td>&nbsp;&nbsp;&nbsp;接口协议:
		   <input type="text" id="tab5" size="14" name="tab5" />
	  </td>
	  <td>&nbsp;&nbsp;&nbsp;接口名称:
		   <input type="text" id="tab6" size="14" name="tab6" />
	  </td>
	  <td>&nbsp;&nbsp;&nbsp;接口表:
		   <input type="text" id="tab7" size="14" name="tab7" />
	  </td>
...
<script type="text/javascript" src="systemInterface.js"></script>