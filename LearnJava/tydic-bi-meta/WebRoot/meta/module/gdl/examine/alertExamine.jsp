...
<head>
    ...
    <script type="text/javascript" src="alertExamine.js"></script>
  ...
  <table>
		<tr>
			...
			<input type="hidden" id="alter_version" style="width: 193px"></input>
			<td id="icoTable"></td>
      ...
      <table cellpadding="0" cellspacing="0" id="_tableBaseInfo" style="height:120px;">
		...
		<tr>
			...
			<td width="85%" >
				...
				<INPUT type=radio name="effectivetime" id="effective_time2" value="2" />延时生效:<INPUT type=calendar id="valid_time" disabled = true  />
