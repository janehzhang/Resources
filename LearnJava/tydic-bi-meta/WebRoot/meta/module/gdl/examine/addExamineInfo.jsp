...
<head>
    ...
    <script type="text/javascript" src="addExamineInfo.js"></script>
   ...
   <div id="pageContent"
	...
	<tr>
      ...
      <table cellpadding="0" cellspacing="0" id="_tableBaseInfo" style="height:120px;">
		<tr>
		   <th width="15%">编码：</th>
		     <td width="35%"><div id="gdl_code">&nbsp;</div></td>
            <th>名称：</th>
            <td style="height: 22px"><div id="gdl_name">&nbsp;</div></td>
		</tr>
		<tr>
			<th>类型：</th>
			<td style="height: 22px"><div id="gdl_type">&nbsp;</div></td>
			<th>状态：</th>
			<td><div id="gdl_state">&nbsp;</div></td>
		</tr>
		<tr>
			<th>单位：</th>
			<td style="height: 22px"><div id="gdl_unit">&nbsp;</div></td>
            <th><%=I18nManager.getItemText(menuId,"GDL_CODE","指标分类")%>：</th>
            <td style="text-align: left;padding: 1px;width: 35%"><div id="gdlGroup">&nbsp;</div></td>
		</tr>
		<tr>
			<th>来源表类：</th>
			<td style="height: 22px"><div id="gdl_src_table_name">&nbsp;</div></td>
            <th>来源列名：</th>
            <td style="text-align: left;padding: 1px;width: 35%"><div id="gdl_col_name"></div></td>
		</tr>
		<tr>
			<th>创建人：</th>
			<td style="height: 22px"><div id="user_namecn"></div></td>
            <th>创建时间：</th>
            <td style="text-align: left;padding: 1px;width: 35%"><div id="create_time"></div></td>
		</tr>
		<tr>
            <th>业务解释：</th>
            <td colspan="3" style="height: 22px"><div id="gdl_bus_desc"></div></td>
		</tr>
	</table>
	 <table>
		<tr>
    ...
    <div id="main" style="width:100%;height:100%;"  >
     ...
     <div id="title" style="width:100%;height:1%;text-align:center;font-weight: bold;font-size:20px;padding-top:5px;"></div>
      ...
      <table cellpadding="0" cellspacing="0" id="_tableBaseInfo" style="height:120px;">
	    ...
	    <tr>
			<th width="15%">审核意见：</th>
			<td width="85%"><div id="audit_opinion">&nbsp;</div></td>
		</tr>
		<tr>
