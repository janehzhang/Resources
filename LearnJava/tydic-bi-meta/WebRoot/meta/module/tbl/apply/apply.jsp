		  ...
		  <tbody>
    		<tr>
		  	...
		  	<tr>
		  		<th width="15%">表类名称：</th>
		  		<td width="35%">
		  			 <input name="tableName" id="_tableName" type="text" style="text-transform: uppercase"></input>		  
		  		...
		  		<th>中文名称：</th>
		  		<td>
		  			 <input name="tableNameCn" id="_tableNameCn" type="text"></input>
		  	...
		  	<tr>
		  		...
		  		<td>
                	...
                	<input name="tableGroup" id="_tableGroup" type="text"></input>
                	<span style="color: red">*</span>
        ...
        <div style="width:100%;" class="gridbox" id="_columnTableDiv">
            <div style="width: 100%; overflow-x: hidden; overflow-y: hidden; position: relative; height: 30px; "
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%;height: 100%; table-layout: fixed;" class="hdr" id="_columnHeadTable">
                    ...
                    <tr>
                        <td style="text-align: center;" nowrap>名称<span style="color: red;">*</span></td>
                        <td style="text-align: center; line-height:22px;" nowrap>列中文名</td>
                        <td style="text-align: center; " nowrap>类型<span style="color: red;">*</span></td>
                        ...
                        <td style="text-align: center; line-height:5px;" nowrap>操作
...
<table cellpadding="0" cellspacing="0" style="width:100%;height: 100%;position: relative;"
    ...
    <form action="" id="_queryDimForm" onsubmit="return false;">
        <tr style="height: 0px; ">
            ...
            <th style="height: 0px; width: 27% "></th>
