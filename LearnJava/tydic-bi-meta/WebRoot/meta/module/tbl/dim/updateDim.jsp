...
<head>
    ...
    <script type="text/javascript">
        ...
        var canModifyDimCol = <%=SystemVariable.getBoolean("canModifyDimCol", true)%>;
       	DimMaintainAction.queryValidVersion(dimTableId, {
    ...
    <script type="text/javascript" src="updateDim.js"></script>
    <style type="text/css">
    	.formAnnotation{
    		 color:#FFA500;
    	}
    		  ...
    		  <td colspan="4" height="5%">
				<table style="width: 100%">
					<tr>
						...
						<td id="tableMeg" style="border: 0px; ">修改表类基本信息</td>
						<td width="88%" style="text-align: right;border:none;">
...
<%--								从原数据表类复制</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--%>
    		...
    		<tr>
    			...
    			<td width="35%">
    				<input name="tableName" id="_tableName" type="text" style="width: 40%" disabled="true"></input>
    		...
    		<tr>
    			...
    			<th>数据源：</th>
    			<td>
    				<select style="height: 20px;width: 208px;" name="dataSourceId" onchange="dataSourceChange(this)"  id="_dataSource" disabled="true">
    		...
    		<tr>
    			...
    			<th>表空间：</th>
    			<td>
    				<select name="tableSpace" id="_tableSpace" type="text" style="width: 40%"></select>
    			</td>
    		</tr>
    		...
    		<tr>
    			<th>所属用户：</th>
    			<td>
    				<select name="tableOwner" id="_tableOwner" style="width: 41%;">
                	</select>
...
<div style="height: 100%; width:100%; " id="_columnFormDiv">
    <form action="" id="_columnForm" style="width:100%;height: auto" onsubmit="return false;">
        ...
        <div style="width: 100%;height: 100%">
            <div style="width:100%;overflow-x:hidden;" class="gridbox" id="_columnTableDiv">
                <div style="width: 100%; overflow-x: hidden; overflow-y: hidden; position: relative; height: 30px; "
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%;height: 100%; table-layout: fixed;" class="hdr" id="_columnHeadTable">
                        ...
                        <tr>
                            ...
                            background-position: -32px 0;cursor: pointer;width: 16px;height: 16px;position: relative;float: right;*top:-20px;" title="缩放" onclick="collapse(this,'_clumnContentDiv','_clumnDimContentDiv')"></div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
                ...
                <div style="width: 100%; overflow-x: hidden; overflow-y: hidden; position: relative; height: 30px; "
                    ...
                    <table cellpadding="0" cellspacing="0" style="width: 100%;height: 100%; table-layout: fixed;" class="hdr" id="_clumnDimHeadTable">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; line-height:22px;">操作
                                <div style="background-image: url('../../../resource/dhtmlx/imgs/dhxlayout_dhx_skyblue/dhxlayout_btns.gif');
                                                         background-position: -32px 0;cursor: pointer;width: 16px;height: 16px;position: relative;float: right;*top:-20px;" title="缩放" onclick="collapse(this,'_clumnDimContentDiv','_clumnContentDiv')"></div>
                            </td>
                        </tr>
                        </tbody>
                    </table>
...
<table cellpadding="0" cellspacing="0" style="width:100%;height: auto;position: relative;"
    ...
    <form action="" id="_dimRefAttrForm" onsubmit="return false;">
        ...
        <tr>
            <%--窗口关闭确定按钮TD--%>
            <td colspan="4" style="text-align: center; margin-top:4px;" id="_dimInfoWindowButton">
            </td>
        </tr>
    </form>
</table>
...
<table cellpadding="0" cellspacing="0" style="width:100%;height: 100%;position: relative;"
    ...
    <form action="" id="_queryTablesFromDb" onsubmit="return false;">
        ...
        <tr style="height: 10%">
            ...
            <td style="text-align: right;padding: 1px;width: 15%">拥有者：</td>
            <td style="text-align: left;padding: 1px;width: 35%">
