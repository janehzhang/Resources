...
<html>
  <head>
	...
	<script type="text/javascript" src="popularData2More.js"></script>
...
<div class="shop">
	<div class="box">
		<span class="name" style="margin-left: 61px;">人气最旺数据查询：</span>
		<input class="biaodan" type="text" id="searchInput" />
        <a class="btn-tj" id="searchButton"></a> 
	</div>
	
	<div class="portlet">
		<div class="box-2" id="portlet2" style="border: 0;">
