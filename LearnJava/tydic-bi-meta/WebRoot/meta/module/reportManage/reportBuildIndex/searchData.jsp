...
<%
	String searchCondition = URLDecoder.decode(request.getParameter("searchCondition"),"UTF-8");
...
<div class="shop">
	<div class="box">
		<span class="name" style="margin-left: 61px;">数据查询：</span>
		<input class="biaodan" type="text"  id="searchInput"/>
        <a class="btn-tj" id="searchButton"></a> 
	</div>
	
	<div class="portlet">
		<div class="box-2" id="portlet3" style="border: 0;">
			<ul class="content" id="searchDataContainer">
