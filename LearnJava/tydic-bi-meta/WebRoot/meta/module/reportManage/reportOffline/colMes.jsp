...
<html>
  <head>
    <title>数据模型字段信息</title>
	<script type="text/javascript" src="<%=rootPath%>/meta/public/code.jsp?types=COL_BUS_TYPE"></script>
	...
	<script type="text/javascript" src="colMes.js"></script>
