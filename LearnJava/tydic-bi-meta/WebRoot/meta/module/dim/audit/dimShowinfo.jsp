...
<head>
    ...
    <script type="text/javascript" src="dimShowinfo.js"></script>
    <style type="text/css">
        #_dimTableForm{
            margin-right: auto;
            margin-left: auto;
...
<form action="" id="_dimTableForm" style="width:100%;height: 100%;">
    <table cellpadding="0" cellspacing="0" style="width:100%;height: 98%"
        ...
        <tr style="height: 100%;width: 100%">
            ...
            <td style="width: 80%">
                <textarea name="auditMark" id="_auditMark" rows="3" readonly="true" style="width: 90%"></textarea><span style="color: red">*</span>
            </td>
        </tr>
        <%--<tr style="height: 20%">--%>
            <%--<td style="height: 100%;width: 100%" colspan="2">--%>
                <%--<div style="height: 100%; width:100%; position: relative;margin-top: -10px" id="_submit"></div>--%>
            <%--</td>--%>
        <%--</tr>--%>
    </table>
</form>
