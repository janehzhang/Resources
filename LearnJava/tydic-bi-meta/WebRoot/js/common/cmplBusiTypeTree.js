 ...
 *  投诉现象树 start
 */
var loadCmplBusiTypeTree=function(selectZone,form){
    ...
    var treeDiv=dhx.html.create("div",{
        style:"position:relative;height:400px;width:400px;padding: 0;margin: 0;" +
              "z-index:1000;"
    });
...
//    div.appendChild(butDiv);
    ...
    var target=   document.getElementById("cmplBusiType");
    var targetId= document.getElementById("cmplBusiTypeCode");
    ...
    tree.setXMLAutoLoading(dwrCaller.querySubCmplBusiType);
        //树双击鼠标事件
    tree.attachEvent("onclick",function(nodeId){
     ...
     dwrCaller.executeAction("loadCmplBusiTypeTree",beginId,selectZone,function(data){
