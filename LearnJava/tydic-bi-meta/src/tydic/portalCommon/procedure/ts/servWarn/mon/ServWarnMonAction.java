 ...
 */
public class ServWarnMonAction {

	private ServWarnMonDAO warnMonDAO;
	...
	public String getNewMonth() {
		try {
			ServWarnMonDAO warnMonDAO = new ServWarnMonDAO();
			return warnMonDAO.getNewMonth();
		} catch (Exception e) {
			Log.error(null, e);
		}
		return "";
	...
	public List<Map<String,Object>> getMonthList(Map<String,Object> param){
		return warnMonDAO.queryMonList(param);
	}
	
	public List<Map<String, Object>> getProdTypeList(Map<String, Object> param) {
		return warnMonDAO.getProdTypeList(param);
	}
	...
	public Map<String, Object> getTableData(Map<String, Object> param) {
		return warnMonDAO.getTableData(param);
	}
	    	...
	    	temp1.append("<categories>\n");
	         ...
	         temp3.append("<dataset  anchorSides='4' anchorRadius='5' anchorBgColor='"+lastColor+"'    seriesName='"+showLastYEAR+"'         color='"+lastColor+"'    anchorBorderColor='FFFFFF'>\n");
		         for (int i = Integer.parseInt(tempMonth); i <= Integer.parseInt(dataDate); i++) {
		    		  ...
		    		  String lastValue="0";
		    		  Map<String, Object> currentObj = warnMonDAO.getChartData(String.valueOf(i),param);
		    		  Map<String, Object> lastObj =    warnMonDAO.getChartData(lastYear,param);
		    	      if (null != currentObj) {
	...
	public Map<String, Object>  bulidBarChart(Map<String, Object> param){
    	...
    	temp1.append("<categories>\n");
      	...
      	String inDate = MapUtils.getString(param, "dateTime", null).replace("-", "");// 当前 年月日
       ...
       /*  if( param.get("changeZone")!= null && param.get("changeZone").equals("0"))
         {
         	list=warnMonDAO.get21DrillTableData(param);
         	labelDisplay="WRAP";
         }else
         {
         	list=warnMonDAO.getDrillTableData(param);
         	labelDisplay="NONE";
         }
        ...
        for (Map<String, Object> key : list){
    	      ...
    	      Map<String, Object> lastObj =    warnMonDAO.getChartData(showLastYEAR,params);
    	      Map<String, Object> curObj =    warnMonDAO.getChartData(inDate,params);
    	      if (null != lastObj) {
    	    	  lastValue = String.valueOf(lastObj.get(field) == null ? "0": lastObj.get(field));
    		   }
    	      if (null != curObj) {
	...
	public void setWarnMonDAO(ServWarnMonDAO warnMonDAO) {
		this.warnMonDAO = warnMonDAO;
	}
